...
(function (e) { function t(a) { if (n[a])
    ...
    for (var o in e)
       ...
       */
        (function (t, n) { 'object' == typeof e.exports ? e.exports = t.document ? n(t, !0) : function (e) { if (!e.document)
            ...
            function p(e) { var t = {}; return be.each(e.match(qe) || [], function (e, n) { t[n] = !0; }), t; }
            ...
            function N(e) { $e.test(e.type) && (e.defaultChecked = e.checked); }
            function T(e, t, n, a, o) { for (var d, s, r, p, c, u, m, h = e.length, l = x(t), g = [], f = 0; f < h; f++)
                if (s = e[f], s || 0 === s)
                    if ('object' === be.type(s))
                        ...
                        p = l.lastChild;
                    } for (p && l.removeChild(p), ye.appendChecked || be.grep(b(g, 'input'), N), f = 0; s = g[f++];) {
            ...
            function _(e) { var t = lt.exec(e.type); return t ? e.type = t[1] : e.removeAttribute('type'), e; }
            ...
            function j(t, n) { var a, o, e; if (1 === n.nodeType) {
            ...
            function A(e, t, n, a) { t = ce.apply([], t); var o, d, s, r, p, c, u = 0, i = e.length, l = t[0], m = be.isFunction(l); if (m || 1 < i && 'string' == typeof l && !ye.checkClone && rt.test(l))
                ...
                if (s)
                    for (p = r[r.length - 1].ownerDocument, be.map(r, _), u = 0; u < s; u++)
            ...
            function I(e, t) { var n = be(t.createElement(e)).appendTo(t.body), a = be.css(n[0], 'display'); return n.detach(), a; }
            function q(e) { var t = le, n = ht[e]; return n || (n = I(e, t), ('none' === n || !n) && (mt = (mt || be('<iframe frameborder=\'0\' width=\'0\' height=\'0\'/>')).appendTo(t.documentElement), t = (mt[0].contentWindow || mt[0].contentDocument).document, t.write(), t.close(), n = I(e, t), mt.detach()), ht[e] = n), n; }
            function M(e, t) { return { get: function () { return e() ? void delete this.get : (this.get = t).apply(this, arguments); } }; }
            function O(e) { if (e in _t)
                return e; for (var t = e.charAt(0).toUpperCase() + e.slice(1), n = Dt.length; n--;)
                if (e = Dt[n] + t, e in _t)
                    return e; }
            function P(e, t) { for (var n, a, o, i = [], d = 0, s = e.length; d < s; d++)
                (a = e[d], !!a.style) && (i[d] = be._data(a, 'olddisplay'), n = a.style.display, t ? (!i[d] && 'none' === n && (a.style.display = ''), '' === a.style.display && ze(a) && (i[d] = be._data(a, 'olddisplay', q(a.nodeName)))) : (o = ze(a), (n && 'none' !== n || !o) && be._data(a, 'olddisplay', o ? n : be.css(a, 'display')))); for (d = 0; d < s; d++)
            ...
            function $(e, t, n) { for (var a, o = (V.tweeners[t] || []).concat(V.tweeners['*']), i = 0, d = o.length; i < d; i++)
                if (a = o[i].call(n, t, e))
                    return a; }
            function U(e, t, n) { var a, o, i, d, s, r, l, p, c = this, u = {}, m = e.style, h = e.nodeType && ze(e), g = be._data(e, 'fxshow'); for (a in n.queue || (s = be._queueHooks(e, 'fx'), null == s.unqueued && (s.unqueued = 0, r = s.empty.fire, s.empty.fire = function () { s.unqueued || r(); }), s.unqueued++, c.always(function () { c.always(function () { s.unqueued--, be.queue(e, 'fx').length || s.empty.fire(); }); })), 1 === e.nodeType && ('height' in t || 'width' in t) && (n.overflow = [m.overflow, m.overflowX, m.overflowY], l = be.css(e, 'display'), p = 'none' === l ? be._data(e, 'olddisplay') || q(e.nodeName) : l, 'inline' === p && 'none' === be.css(e, 'float') && (ye.inlineBlockNeedsLayout && 'inline' !== q(e.nodeName) ? m.zoom = 1 : m.display = 'inline-block')), n.overflow && (m.overflow = 'hidden', !ye.shrinkWrapBlocks() && c.always(function () { m.overflow = n.overflow[0], m.overflowX = n.overflow[1], m.overflowY = n.overflow[2]; })), t)
                if (o = t[a], At.exec(o)) {
                ...
                'inline' === ('none' === l ? q(e.nodeName) : l) && (m.display = l); }
            ...
            function K(e) { return function (t, n) { 'string' != typeof t && (n = t, t = '*'); var a, o = 0, i = t.toLowerCase().match(qe) || []; if (be.isFunction(n))
                for (; a = i[o++];)
            ...
            var se = Math.max, re = [], le = o.document, pe = re.slice, ce = re.concat, ue = re.push, me = re.indexOf, he = {}, ge = he.toString, fe = he.hasOwnProperty, ye = {}, xe = '1.12.4', be = function (e, t) { return new be.fn.init(e, t); }, ve = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, Ne = /^-ms-/, Te = /-([\da-z])/gi, Ce = function (e, t) { return t.toUpperCase(); };
            be.fn = be.prototype = { jquery: xe, constructor: be, selector: '', length: 0, toArray: function () { return pe.call(this); }, get: function (e) { return null == e ? pe.call(this) : 0 > e ? this[e + this.length] : this[e]; }, pushStack: function (e) { var t = be.merge(this.constructor(), e); return t.prevObject = this, t.context = this.context, t; }, each: function (e) { return be.each(this, e); }, map: function (e) { return this.pushStack(be.map(this, function (t, n) { return e.call(t, n, t); })); }, slice: function () { return this.pushStack(pe.apply(this, arguments)); }, first: function () { return this.eq(0); }, last: function () { return this.eq(-1); }, eq: function (e) { var t = this.length, n = +e + (0 > e ? t : 0); return this.pushStack(0 <= n && n < t ? [this[n]] : []); }, end: function () { return this.prevObject || this.constructor(); }, push: ue, sort: re.sort, splice: re.splice }, be.extend = be.fn.extend = function () { var e, t, n, a, o, d, s = arguments[0] || {}, r = 1, i = arguments.length, l = !1; for ('boolean' == typeof s && (l = s, s = arguments[r] || {}, r++), 'object' == typeof s || be.isFunction(s) || (s = {}), r === i && (s = this, r--); r < i; r++)
                if (null != (o = arguments[r]))
                    ...
                    ; return void 0 == t || fe.call(e, t); }, type: function (e) { return null == e ? e + '' : 'object' == typeof e || 'function' == typeof e ? he[ge.call(e)] || 'object' : typeof e; }, globalEval: function (e) { e && be.trim(e) && (o.execScript || function (e) { o.eval.call(o, e); })(e); }, camelCase: function (e) { return e.replace(Ne, 'ms-').replace(Te, Ce); }, nodeName: function (e, t) { return e.nodeName && e.nodeName.toLowerCase() === t.toLowerCase(); }, each: function (e, t) { var n, a = 0; if (s(e))
            ...
            */ function (e) { function t(e, t, n, a) { var o, d, i, s, r, l, p, u, h = t && t.ownerDocument, g = t ? t.nodeType : 9; if (n = n || [], 'string' != typeof e || !e || 1 !== g && 9 !== g && 11 !== g)
                return n; if (!a && ((t ? t.ownerDocument || t : W) !== H && A(t), t = t || H, I)) {
                if (11 !== g && (l = ge.exec(e)))
                    if (!(o = l[1])) {
                        if (l[2])
            ...
            } return S(e.replace(ie, '$1'), t, n, a); } function n() { function e(n, a) { return t.push(n + ' ') > C.cacheLength && delete e[t.shift()], e[n + ' '] = a; } var t = []; return e; } function a(e) { return e[B] = !0, e; } function o(e) { var t = H.createElement('div'); try {
                return !!e(t);
            }
            catch (t) {
                return !1;
                ...
                C.attrHandle[n[a]] = t; } function s(e, t) { var n = t && e, a = n && 1 === e.nodeType && 1 === t.nodeType && (~t.sourceIndex || G) - (~e.sourceIndex || G); if (a)
                return a; if (n)
                for (; n = n.nextSibling;)
                    if (n === t)
            ...
            } }); } function b(e) { for (var t, n, a, o = e.length, d = C.relative[e[0].type], s = d || C.relative[' '], r = d ? 1 : 0, i = h(function (e) { return e === t; }, s, !0), l = h(function (e) { return -1 < ee(t, e); }, s, !0), p = [function (e, n, a) { var o = !d && (a || n !== D) || ((t = n).nodeType ? i(e, n, a) : l(e, n, a)); return t = null, o; }]; r < o; r++)
                if (n = C.relative[e[r].type])
                    p = [h(g(p), n)];
                else {
                    if (n = C.filter[e[r].type].apply(null, e[r].matches), n[B]) {
                        for (a = ++r; a < o && !C.relative[e[a].type]; a++)
                            ;
                        return x(1 < r && g(p), 1 < r && m(e.slice(0, r - 1).concat({ value: ' ' === e[r - 2].type ? '*' : '' })).replace(ie, '$1'), n, r < a && b(e.slice(r, a)), a < o && b(e = e.slice(a)), a < o && m(e));
                    }
                    p.push(n);
                } return g(p); } function v(e, n) { var o = 0 < n.length, d = 0 < e.length, i = function (a, s, r, l, p) { var c, u, m, h = 0, g = '0', i = a && [], f = [], x = D, b = a || d && C.find.TAG('*', p), v = F += null == x ? 1 : Math.random() || .1, N = b.length; for (p && (D = s === H || s || p); g !== N && null != (c = b[g]); g++) {
                if (d && c) {
                    for (u = 0, s || c.ownerDocument === H || (A(c), r = !I); m = e[u++];)
                        if (m(c, s || H, r)) {
                            l.push(c);
                            break;
                        }
            ...
            } return p && (F = v, D = x), i; }; return o ? a(i) : i; } var N, T, C, w, i, E, k, S, D, _, L, A, H, j, I, q, M, O, P, B = 'sizzle' + 1 * new Date, W = e.document, F = 0, R = 0, z = n(), X = n(), $ = n(), U = function (e, t) { return e === t && (L = !0), 0; }, G = -2147483648, V = {}.hasOwnProperty, J = [], K = J.pop, Y = J.push, Q = J.push, Z = J.slice, ee = function (e, t) { for (var n = 0, a = e.length; n < a; n++)
                if (e[n] === t)
                ...
                Q = { apply: J.length ? function (e, t) { Y.apply(e, Z.call(t)); } : function (e, t) { for (var n = e.length, a = 0; e[n++] = t[a++];)
                        ; e.length = n - 1; } };
            } for (N in T = t.support = {}, i = t.isXML = function (e) { var t = e && (e.ownerDocument || e).documentElement; return !!t && 'HTML' !== t.nodeName; }, A = t.setDocument = function (e) { var t, n, a = e ? e.ownerDocument || e : W; return a !== H && 9 === a.nodeType && a.documentElement ? (H = a, j = H.documentElement, I = !i(H), (n = H.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener('unload', ve, !1) : n.attachEvent && n.attachEvent('onunload', ve)), T.attributes = o(function (e) { return e.className = 'i', !e.getAttribute('className'); }), T.getElementsByTagName = o(function (e) { return e.appendChild(H.createComment('')), !e.getElementsByTagName('*').length; }), T.getElementsByClassName = he.test(H.getElementsByClassName), T.getById = o(function (e) { return j.appendChild(e).id = B, !H.getElementsByName || !H.getElementsByName(B).length; }), T.getById ? (C.find.ID = function (e, t) { if ('undefined' != typeof t.getElementById && I) {
                var n = t.getElementById(e);
                return n ? [n] : [];
            } }, C.filter.ID = function (e) { var t = e.replace(xe, be); return function (e) { return e.getAttribute('id') === t; }; }) : (delete C.find.ID, C.filter.ID = function (e) { var t = e.replace(xe, be); return function (e) { var n = 'undefined' != typeof e.getAttributeNode && e.getAttributeNode('id'); return n && n.value === t; }; }), C.find.TAG = T.getElementsByTagName ? function (e, t) { return 'undefined' == typeof t.getElementsByTagName ? T.qsa ? t.querySelectorAll(e) : void 0 : t.getElementsByTagName(e); } : function (e, t) { var n, a = [], o = 0, i = t.getElementsByTagName(e); if ('*' === e) {
                for (; n = i[o++];)
                    1 === n.nodeType && a.push(n);
                return a;
            } return i; }, C.find.CLASS = T.getElementsByClassName && function (e, t) { if ('undefined' != typeof t.getElementsByClassName && I)
                return t.getElementsByClassName(e); }, M = [], q = [], (T.qsa = he.test(H.querySelectorAll)) && (o(function (e) { j.appendChild(e).innerHTML = '<a id=\'' + B + '\'></a><select id=\'' + B + '-\r\\\' msallowcapture=\'\'><option selected=\'\'></option></select>', e.querySelectorAll('[msallowcapture^=\'\']').length && q.push('[*^$]=' + ne + '*(?:\'\'|"")'), e.querySelectorAll('[selected]').length || q.push('\\[' + ne + '*(?:value|' + te + ')'), e.querySelectorAll('[id~=' + B + '-]').length || q.push('~='), e.querySelectorAll(':checked').length || q.push(':checked'), e.querySelectorAll('a#' + B + '+*').length || q.push('.#.+[+~]'); }), o(function (e) { var t = H.createElement('input'); t.setAttribute('type', 'hidden'), e.appendChild(t).setAttribute('name', 'D'), e.querySelectorAll('[name=d]').length && q.push('name' + ne + '*[*^$|!~]?='), e.querySelectorAll(':enabled').length || q.push(':enabled', ':disabled'), e.querySelectorAll('*,:x'), q.push(',.*:'); })), (T.matchesSelector = he.test(O = j.matches || j.webkitMatchesSelector || j.mozMatchesSelector || j.oMatchesSelector || j.msMatchesSelector)) && o(function (e) { T.disconnectedMatch = O.call(e, 'div'), O.call(e, '[s!=\'\']:x'), M.push('!=', ':(' + ae + ')(?:\\(((\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)")|((?:\\\\.|[^\\\\()[\\]]|' + ('\\[' + ne + '*(' + ae + ')(?:' + ne + '*([*^$|!~]?=)' + ne + '*(?:\'((?:\\\\.|[^\\\\\'])*)\'|"((?:\\\\.|[^\\\\"])*)"|(' + ae + '))|)' + ne + '*\\]') + ')*)|.*)\\)|)'); }), q = q.length && new RegExp(q.join('|')), M = M.length && new RegExp(M.join('|')), t = he.test(j.compareDocumentPosition), P = t || he.test(j.contains) ? function (e, t) { var n = 9 === e.nodeType ? e.documentElement : e, a = t && t.parentNode; return e === a || !!(a && 1 === a.nodeType && (n.contains ? n.contains(a) : e.compareDocumentPosition && 16 & e.compareDocumentPosition(a))); } : function (e, t) { if (t)
                for (; t = t.parentNode;)
                    if (t === e)
                        return !0; return !1; }, U = t ? function (e, t) { if (e === t)
                return L = !0, 0; var n = !e.compareDocumentPosition - !t.compareDocumentPosition; return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !T.sortDetached && t.compareDocumentPosition(e) === n ? e === H || e.ownerDocument === W && P(W, e) ? -1 : t === H || t.ownerDocument === W && P(W, t) ? 1 : _ ? ee(_, e) - ee(_, t) : 0 : 4 & n ? -1 : 1); } : function (e, t) { if (e === t)
                return L = !0, 0; var n, a = 0, o = e.parentNode, i = t.parentNode, d = [e], r = [t]; if (!o || !i)
                return e === H ? -1 : t === H ? 1 : o ? -1 : i ? 1 : _ ? ee(_, e) - ee(_, t) : 0; if (o === i)
                return s(e, t); for (n = e; n = n.parentNode;)
                d.unshift(n); for (n = t; n = n.parentNode;)
                r.unshift(n); for (; d[a] === r[a];)
                a++; return a ? s(d[a], r[a]) : d[a] === W ? -1 : r[a] === W ? 1 : 0; }, H) : H; }, t.matches = function (e, n) { return t(e, null, null, n); }, t.matchesSelector = function (e, n) { if ((e.ownerDocument || e) !== H && A(e), n = n.replace(re, '=\'$1\']'), T.matchesSelector && I && !$[n + ' '] && (!M || !M.test(n)) && (!q || !q.test(n)))
                try {
                    var a = O.call(e, n);
                    if (a || T.disconnectedMatch || e.document && 11 !== e.document.nodeType)
                        return a;
                }
                catch (t) { } return 0 < t(n, H, null, [e]).length; }, t.contains = function (e, t) { return (e.ownerDocument || e) !== H && A(e), P(e, t); }, t.attr = function (e, t) { (e.ownerDocument || e) !== H && A(e); var n = C.attrHandle[t.toLowerCase()], a = n && V.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !I) : void 0; return void 0 === a ? T.attributes || !I ? e.getAttribute(t) : (a = e.getAttributeNode(t)) && a.specified ? a.value : null : a; }, t.error = function (e) { throw new Error('Syntax error, unrecognized expression: ' + e); }, t.uniqueSort = function (e) { var t, n = [], a = 0, o = 0; if (L = !T.detectDuplicates, _ = !T.sortStable && e.slice(0), e.sort(U), L) {
                for (; t = e[o++];)
                    t === e[o] && (a = n.push(o));
                for (; a--;)
                    e.splice(n[a], 1);
            } return _ = null, e; }, w = t.getText = function (e) { var t, n = '', a = 0, o = e.nodeType; if (!o)
                for (; t = e[a++];)
                    n += w(t);
                ...
                return e.nodeValue; return n; }, C = t.selectors = { cacheLength: 50, createPseudo: a, match: ce, attrHandle: {}, find: {}, relative: { ">": { dir: 'parentNode', first: !0 }, " ": { dir: 'parentNode' }, "+": { dir: 'previousSibling', first: !0 }, "~": { dir: 'previousSibling' } }, preFilter: { ATTR: function (e) { return e[1] = e[1].replace(xe, be), e[3] = (e[3] || e[4] || e[5] || '').replace(xe, be), '~=' === e[2] && (e[3] = ' ' + e[3] + ' '), e.slice(0, 4); }, CHILD: function (e) { return e[1] = e[1].toLowerCase(), 'nth' === e[1].slice(0, 3) ? (!e[3] && t.error(e[0]), e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ('even' === e[3] || 'odd' === e[3])), e[5] = +(e[7] + e[8] || 'odd' === e[3])) : e[3] && t.error(e[0]), e; }, PSEUDO: function (e) { var t, n = !e[6] && e[2]; return ce.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || '' : n && le.test(n) && (t = E(n, !0)) && (t = n.indexOf(')', n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3)); } }, filter: { TAG: function (e) { var t = e.replace(xe, be).toLowerCase(); return '*' === e ? function () { return !0; } : function (e) { return e.nodeName && e.nodeName.toLowerCase() === t; }; }, CLASS: function (e) { var t = z[e + ' ']; return t || (t = new RegExp('(^|' + ne + ')' + e + '(' + ne + '|$)')) && z(e, function (e) { return t.test('string' == typeof e.className && e.className || 'undefined' != typeof e.getAttribute && e.getAttribute('class') || ''); }); }, ATTR: function (e, n, a) { return function (o) { var i = t.attr(o, e); return null == i ? '!=' === n : !n || (i += '', '=' === n ? i === a : '!=' === n ? i !== a : '^=' === n ? a && 0 === i.indexOf(a) : '*=' === n ? a && -1 < i.indexOf(a) : '$=' === n ? a && i.slice(-a.length) === a : '~=' === n ? -1 < (' ' + i.replace(oe, ' ') + ' ').indexOf(a) : '|=' == n && (i === a || i.slice(0, a.length + 1) === a + '-')); }; }, CHILD: function (e, t, n, a, o) { var i = 'nth' !== e.slice(0, 3), d = 'last' !== e.slice(-4), s = 'of-type' === t; return 1 === a && 0 === o ? function (e) { return !!e.parentNode; } : function (t, n, r) { var l, p, c, u, m, h, g = i == d ? 'previousSibling' : 'nextSibling', f = t.parentNode, y = s && t.nodeName.toLowerCase(), x = !r && !s, b = !1; if (f) {
                    ...
                    } }; }, PSEUDO: function (e, n) { var o, d = C.pseudos[e] || C.setFilters[e.toLowerCase()] || t.error('unsupported pseudo: ' + e); return d[B] ? d(n) : 1 < d.length ? (o = [e, e, '', n], C.setFilters.hasOwnProperty(e.toLowerCase()) ? a(function (e, t) { for (var a, o = d(e, n), s = o.length; s--;)
                    ...
                    while ((t = t.parentNode) && 1 === t.nodeType); return !1; }; }), target: function (t) { var n = e.location && e.location.hash; return n && n.slice(1) === t.id; }, root: function (e) { return e === j; }, focus: function (e) { return e === H.activeElement && (!H.hasFocus || H.hasFocus()) && !!(e.type || e.href || ~e.tabIndex); }, enabled: function (e) { return !1 === e.disabled; }, disabled: function (e) { return !0 === e.disabled; }, checked: function (e) { var t = e.nodeName.toLowerCase(); return 'input' === t && !!e.checked || 'option' === t && !!e.selected; }, selected: function (e) { return e.parentNode && e.parentNode.selectedIndex, !0 === e.selected; }, empty: function (e) { for (e = e.firstChild; e; e = e.nextSibling)
                        if (6 > e.nodeType)
                            return !1; return !0; }, parent: function (e) { return !C.pseudos.empty(e); }, header: function (e) { return me.test(e.nodeName); }, input: function (e) { return ue.test(e.nodeName); }, button: function (e) { var t = e.nodeName.toLowerCase(); return 'input' === t && 'button' === e.type || 'button' === t; }, text: function (e) { var t; return 'input' === e.nodeName.toLowerCase() && 'text' === e.type && (null == (t = e.getAttribute('type')) || 'text' === t.toLowerCase()); }, first: p(function () { return [0]; }), last: p(function (e, t) { return [t - 1]; }), eq: p(function (e, t, n) { return [0 > n ? n + t : n]; }), even: p(function (e, t) { for (var n = 0; n < t; n += 2)
                        ...
                        e.push(a); return e; }) } }, C.pseudos.nth = C.pseudos.eq, { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })
                C.pseudos[N] = r(N); for (N in { submit: !0, reset: !0 })
                C.pseudos[N] = l(N); return u.prototype = C.filters = C.pseudos, C.setFilters = new u, E = t.tokenize = function (e, n) { var a, o, i, d, s, r, l, p = X[e + ' ']; if (p)
                return n ? 0 : p.slice(0); for (s = e, r = [], l = C.preFilter; s;) {
                for (d in (!a || (o = de.exec(s))) && (o && (s = s.slice(o[0].length) || s), r.push(i = [])), a = !1, (o = se.exec(s)) && (a = o.shift(), i.push({ value: a, type: o[0].replace(ie, ' ') }), s = s.slice(a.length)), C.filter)
                ...
                if (i = p[0] = p[0].slice(0), 2 < i.length && 'ID' === (d = i[0]).type && T.getById && 9 === t.nodeType && I && C.relative[i[1].type]) {
                    if (t = (C.find.ID(d.matches[0].replace(xe, be), t) || [])[0], !t)
                        return n;
                    l && (t = t.parentNode), e = e.slice(i.shift().value.length);
                }
                for (o = ce.needsContext.test(e) ? 0 : i.length; o-- && (d = i[o], !C.relative[s = d.type]);)
                    if ((r = C.find[s]) && (a = r(d.matches[0].replace(xe, be), fe.test(i[0].type) && c(t.parentNode) || t))) {
                        if (i.splice(o, 1), e = a.length && m(i), !e)
                            return Q.apply(n, a), n;
                        break;
                    }
            } return (l || k(e, p))(a, t, !I, n, !t || fe.test(e) && c(t.parentNode) || t), n; }, T.sortStable = B.split('').sort(U).join('') === B, T.detectDuplicates = !!L, A(), T.sortDetached = o(function (e) { return 1 & e.compareDocumentPosition(H.createElement('div')); }), o(function (e) { return e.innerHTML = '<a href=\'#\'></a>', '#' === e.firstChild.getAttribute('href'); }) || d('type|href|height|width', function (e, t, n) { if (!n)
            ...
            var Ee = function (e, t, n) { for (var a = []; (e = e[t]) && 9 !== e.nodeType;)
                ...
                1 === e.nodeType && e !== t && n.push(e); return n; }, Se = be.expr.match.needsContext, De = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, _e = /^.[^:#\[\.,]*$/;
            ...
            var Le, je = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, Ae = be.fn.init = function (e, t, n) { var a, o; if (!e)
            ...
            var He = /^(?:parents|prev(?:Until|All))/, Ie = { children: !0, contents: !0, next: !0, prev: !0 };
            ...
            be.event = { global: {}, add: function (e, n, a, o, i) { var d, s, r, t, l, p, c, u, m, h, g, f = be._data(e); if (f) {
                    for (a.handler && (t = a, a = t.handler, i = t.selector), a.guid || (a.guid = be.guid++), (s = f.events) || (s = f.events = {}), (p = f.handle) || (p = f.handle = function (t) { return 'undefined' == typeof be || t && be.event.triggered === t.type ? void 0 : be.event.dispatch.apply(p.elem, arguments); }, p.elem = e), n = (n || '').match(qe) || [''], r = n.length; r--;)
            ...
            be.extend({ cssHooks: { opacity: { get: function (e, t) { if (t) {
                    ...
                    if (t = be.cssProps[s] || (be.cssProps[s] = O(s) || s), d = be.cssHooks[t] || be.cssHooks[s], void 0 !== n) {
                ...
                } }, css: function (e, t, n, a) { var o, i, d, s = be.camelCase(t); return t = be.cssProps[s] || (be.cssProps[s] = O(s) || s), d = be.cssHooks[t] || be.cssHooks[s], d && 'get' in d && (i = d.get(e, !0, n)), void 0 === i && (i = vt(e, t, a)), 'normal' === i && t in St && (i = St[t]), '' === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i; } }), be.each(['height', 'width'], function (e, t) { be.cssHooks[t] = { get: function (e, n, a) { if (n)
                    return wt.test(be.css(e, 'display')) && 0 === e.offsetWidth ? yt(e, kt, function () { return F(e, t, a); }) : F(e, t, a); }, set: function (e, n, a) { var o = a && bt(e); return B(e, n, a ? W(e, t, a, ye.boxSizing && 'border-box' === be.css(e, 'boxSizing', !1, o), o) : 0); } }; }), ye.opacity || (be.cssHooks.opacity = { get: function (e, t) { return Ct.test((t && e.currentStyle ? e.currentStyle.filter : e.style.filter) || '') ? .01 * parseFloat(RegExp.$1) + '' : t ? '1' : ''; }, set: function (e, t) { var n = e.style, a = e.currentStyle, o = be.isNumeric(t) ? 'alpha(opacity=' + 100 * t + ')' : '', i = a && a.filter || n.filter || ''; n.zoom = 1, (1 <= t || '' === t) && '' === be.trim(i.replace(Tt, '')) && n.removeAttribute && (n.removeAttribute('filter'), '' === t || a && !a.filter) || (n.filter = Tt.test(i) ? i.replace(Tt, o) : i + ' ' + o); } }), be.cssHooks.marginRight = M(ye.reliableMarginRight, function (e, t) { if (t)
            ...
            var Lt, jt, At = /^(?:toggle|show|hide)$/, Ht = /queueHooks$/;
            be.Animation = be.extend(V, { tweeners: { "*": [function (e, t) { var n = this.createTween(e, t); return y(n.elem, e, Fe.exec(t), n), n; }] }, tweener: function (e, t) { be.isFunction(e) ? (t = e, e = ['*']) : e = e.match(qe); for (var n, a = 0, o = e.length; a < o; a++)
            ...
            var Mt, Ot, Pt = be.expr.attrHandle, Bt = /^(?:checked|selected)$/i, Wt = ye.getSetAttribute, Ft = ye.input;
            ...
            be.fn.extend({ addClass: function (e) { var t, n, a, o, d, s, r, l = 0; if (be.isFunction(e))
                    ...
                    for (a = 0, o = be(this), i = e.match(qe) || []; t = i[a++];)
            ...
            be.extend({ active: 0, lastModified: {}, etag: {}, ajaxSettings: { url: dn, type: 'GET', isLocal: Qt.test(sn[1]), global: !0, processData: !0, async: !0, contentType: 'application/x-www-form-urlencoded; charset=UTF-8', accepts: { "*": on, text: 'text/plain', html: 'text/html', xml: 'application/xml, text/xml', json: 'application/json, text/javascript' }, contents: { xml: /\bxml\b/, html: /\bhtml/, json: /\bjson\b/ }, responseFields: { xml: 'responseXML', text: 'responseText', json: 'responseJSON' }, converters: { "* text": String, "text html": !0, "text json": be.parseJSON, "text xml": be.parseXML }, flatOptions: { url: !0, context: !0 } }, ajaxSetup: function (e, t) { return t ? Q(Q(e, be.ajaxSettings), t) : Q(be.ajaxSettings, e); }, ajaxPrefilter: K(nn), ajaxTransport: K(an), ajax: function (e, t) { function n(e, t, n, a) { var d, u, x, b, N, C = t; 2 === v || (v = 2, l && o.clearTimeout(l), c = void 0, r = a || '', T.readyState = 0 < e ? 4 : 0, d = 200 <= e && 300 > e || 304 === e, n && (b = Z(m, T, n)), b = ee(m, b, T, d), d ? (m.ifModified && (N = T.getResponseHeader('Last-Modified'), N && (be.lastModified[i] = N), N = T.getResponseHeader('etag'), N && (be.etag[i] = N)), 204 === e || 'HEAD' === m.type ? C = 'nocontent' : 304 === e ? C = 'notmodified' : (C = b.state, u = b.data, x = b.error, d = !x)) : (x = C, (e || !C) && (C = 'error', 0 > e && (e = 0))), T.status = e, T.statusText = (t || C) + '', d ? g.resolveWith(s, [u, C, T]) : g.rejectWith(s, [T, C, x]), T.statusCode(y), y = void 0, p && h.trigger(d ? 'ajaxSuccess' : 'ajaxError', [T, m, d ? u : x]), f.fireWith(s, [T, C]), p && (h.trigger('ajaxComplete', [T, m]), !--be.active && be.event.trigger('ajaxStop'))); } 'object' == typeof e && (t = e, e = void 0), t = t || {}; var a, d, i, r, l, p, c, u, m = be.ajaxSetup({}, t), s = m.context || m, h = m.context && (s.nodeType || s.jquery) ? be(s) : be.event, g = be.Deferred(), f = be.Callbacks('once memory'), y = m.statusCode || {}, x = {}, b = {}, v = 0, N = 'canceled', T = { readyState: 0, getResponseHeader: function (e) { var t; if (2 == v) {
                        if (!u)
                            for (u = {}; t = Yt.exec(r);)
                        ...
                        if (2 > v)
                            ...
                            T.always(e[T.status]); return this; }, abort: function (e) { var t = e || N; return c && c.abort(t), n(0, t), this; } }; if (g.promise(T).complete = f.add, T.success = T.done, T.error = T.fail, m.url = ((e || m.url || dn) + '').replace(Jt, '').replace(en, sn[1] + '//'), m.type = t.method || t.type || m.method || m.type, m.dataTypes = be.trim(m.dataType || '*').toLowerCase().match(qe) || [''], null == m.crossDomain && (a = tn.exec(m.url.toLowerCase()), m.crossDomain = !!(a && (a[1] !== sn[1] || a[2] !== sn[2] || (a[3] || ('http:' === a[1] ? '80' : '443')) !== (sn[3] || ('http:' === sn[1] ? '80' : '443'))))), m.data && m.processData && 'string' != typeof m.data && (m.data = be.param(m.data, m.traditional)), Y(nn, m, t, T), 2 == v)
                    ...
                    return T.abort(); for (d in N = 'abort', { success: 1, error: 1, complete: 1 })
    ...
    }, "./src/Components/dynamicDataTable/index.ts": /*!**************************************************!*\
    !*** ./src/Components/dynamicDataTable/index.ts ***!
    \**************************************************/ /*! no static exports found */ function (e, t, n) {
        'use strict';
        var a = this && this.__assign || function () { return a = Object.assign || function (e) { for (var t, a = 1, o = arguments.length; a < o; a++)
            ...
            for (var d = arguments[t], a = 0, s = d.length; a < s; a++, i++)
                o[i] = d[a]; return o; };
        t.__esModule = !0;
        var i = n(/*! ../../utils */ './src/utils.ts'), d = n(/*! ./staticComponents */ './src/Components/dynamicDataTable/staticComponents.ts'), s = n(/*! .. */ './src/Components/index.ts'), r = n(/*! ../../examples/formExample/inputs */ './src/examples/formExample/inputs.ts'), l = function (e) { function n(e) { var t = document.getElementById(h); t.removeChild(t.childNodes[e]); } function p() { var e = i.createElement({ tagName: 'form' }), n = { formNumber: { value: 'armin', type: 'text', name: 'formNumber' }, firstName: { value: 'armin', type: 'text', name: 'firstName' }, lastName: { value: 'armin', type: 'text', name: 'lastName' } }, a = l({ initialRows: [{ renderer: t.mapIntoTD([{ input: r.formNumberInput(n.formNumber) }, { input: r.firstNameInput(n.firstName) }, { input: r.lastNameInput(n.lastName) }]) }] }); e.appendChild(a); var o = s.Modal({ htmlSrc: './dynamic-data-modal.html', dialogArguments: { formType: 2 } }); document.getElementById('root').appendChild(o); } var c = e.initialRows, u = void 0 === c ? [] : c, m = i.elementIdGenerator.gererate(), h = i.elementIdGenerator.gererate(), g = o(u.map(function (e, s) { return a(a({}, e), { renderer: o(t.mapIntoTD([d.removeCell(s, n)]), e.renderer, t.mapIntoTD([d.settingCell(s, p)])) }); }), [d.addNewRow(function () { for (var e, t = document.getElementById(h).childNodes.length - 1, a = d.emptyRow(t, n, p), o = i.createElement({ tagName: 'tr', props: {} }), s = 0, r = a.renderer; s < r.length; s++)
                e = r[s], o.appendChild(e); var l = document.getElementById(h); l.insertBefore(o, l.lastChild); })]); return function () { for (var e = i.createElement({ tagName: 'table', props: { className: 'table-base-row', id: m, dir: 'rtl' } }), t = i.createElement({ tagName: 'tbody', props: { id: h } }), n = 0, a = g; n < a.length; n++) {
            for (var o, d = a[n], s = i.createElement({ tagName: 'tr', props: {} }), r = 0, l = d.renderer; r < l.length; r++)
                o = l[r], s.appendChild(o);
            t.appendChild(s);
        } return e.appendChild(t), e; }(); };
        t.mapIntoTD = function (e) { return e.map(function (e) { var t = i.createElement({ tagName: 'td', props: a({}, e.cellProps) }); return t.appendChild(e.input), t; }); }, t['default'] = i.withErrorHandling(l, 'TableBasedRow');
    }, "./src/Components/dynamicDataTable/staticComponents.ts": /*!*************************************************************!*\
    !*** ./src/Components/dynamicDataTable/staticComponents.ts ***!
    \*************************************************************/ /*! no static exports found */ function (e, t, n) {
        'use strict';
        function a(e, t) { return { input: d.createElement({ tagName: 'input', props: { className: 'dynamic-table__row__remove-button', type: 'button', value: 'x', onclick: function () { t(e); } } }), cellProps: { style: { width: '50px' } } }; }
        function o(e, t) { return { input: d.createElement({ tagName: 'input', props: { className: 'dynamic-table__row__setting-button', type: 'button', value: '...', onclick: function () { t(e); } } }) }; }
        t.__esModule = !0;
        var i = n(/*! ../tableBaseOnRow */ './src/Components/tableBaseOnRow.ts'), d = n(/*! ../../utils */ './src/utils.ts');
        t.addNewRow = function (e) { return { renderer: i.mapIntoTD([{ input: d.createElement({ tagName: 'input', props: { className: 'dynamic-table__row__add-button', type: 'button', value: '+', onclick: function () { e(); } } }) }]) }; }, t.emptyRow = function (e, t, n) { return { renderer: i.mapIntoTD([a(e, t), { input: d.createElement({ tagName: 'input' }) }, { input: d.createElement({ tagName: 'input' }) }, { input: d.createElement({ tagName: 'input' }) }, o(e, n)]) }; }, t.removeCell = a, t.settingCell = o;
    ...
    \*********************************/ /*! no static exports found */ function (e, t, n) {
        ...
        t['default'] = a.withErrorHandling(function (e) { for (var t = e.dataSource, n = e.columns, o = n.map(function (e) { return e.dataIndex; }), i = a.createElement({ tagName: 'table' }), s = a.createElement({ tagName: 'thead' }), r = a.createElement({ tagName: 'tr' }), l = a.createElement({ tagName: 'tbody' }), p = 0, c = n; p < c.length; p++) {
            ...
            for (var f, y = g[h], d = a.createElement({ tagName: 'tr' }), x = [], b = function (e) { var t = a.createElement({ tagName: 'td' }), o = n.find(function (t) { return t.dataIndex === e; }).renderer; if (o) {
                ...
                t.innerHTML = y[e]; x.push(t); }, v = 0, N = o; v < N.length; v++)
                f = N[v], b(f);
            for (var T, C = 0, w = x; C < w.length; C++)
                T = w[C], d.appendChild(T);
            l.appendChild(d);
    ...
    \********************************************/ /*! no static exports found */ function (e, t, n) {
        ...
        t.formNumberInput = function (e) { return o.createElement({ tagName: 'input', props: a({}, e) }); }, t.firstNameInput = function (e) { return o.createElement({ tagName: 'input', props: a({}, e) }); }, t.lastNameInput = function (e) { return o.createElement({ tagName: 'input', props: a({}, e) }); };
        var r = function (e) { return o.createElement({ tagName: 'span', props: { id: 'from-date-datePicker', style: { width: '240px' } }, onMount: function () { document.getElementById('from-date-datePicker').innerHTML = '<input type=\'text\' style=\'display:none;\' id=\'txt12345\' name="' + (e.name || '') + '" value="' + (e.value || '') + '" /><ccc:datePicker showTime=\'true\' forceShowTime=\'true\'/>'; } }); };
        t.fromDateInput = function (e) { return r(e); }, t.toDateInput = function (e) { return o.createElement({ tagName: 'input', props: a({}, e) }); }, t.statusInput = function (e) { return i.Select(a({ options: e.options, value: e.value }, e)); }, t.employmentTypeInput = function (e) { return s['default'](i.Select(a({ options: e.options, value: e.value }, e)), 'employment type'); }, t.genderInput = function (e) { return s['default'](i.Select(a({ options: e.options, value: e.value }, e)), 'gender'); }, t.maritalStatusInput = function (e) { return s['default'](i.Select(a({ options: e.options, value: e.value }, e)), 'maritial'); }, t.countryInput = function (e) { return s['default'](o.createElement({ tagName: 'input', props: a({}, e) }), 'country'); }, t.fromBirthDateInput = function (e) { return s['default'](o.createElement({ tagName: 'input', props: a({}, e) }), 'from birth date'); }, t.toBirthDateInput = function (e) { return s['default'](o.createElement({ tagName: 'input', props: a({}, e) }), 'to birth date'); }, t.cityInput = function (e) { return s['default'](o.createElement({ tagName: 'input', props: a({}, e) }), 'city'); }, t.languageLevelInput = function (e) { return s['default'](o.createElement({ tagName: 'input', props: a({}, e) }), 'language level'); }, t.languagesInput = function (e) { return s['default'](o.createElement({ tagName: 'input', props: a({}, e) }), 'laguages'); };
    }, "./src/main.ts": /*!*********************!*\
    !*** ./src/main.ts ***!
    \*********************/ /*! no static exports found */ function (e, t, n) {
        'use strict';
        t.__esModule = !0;
        var a = n(/*! ./Components/dynamicDataTable */ './src/Components/dynamicDataTable/index.ts'), o = n(/*! ./examples/formExample/inputs */ './src/examples/formExample/inputs.ts'), i = { formNumber: { value: 'armin', type: 'text', name: 'formNumber' }, firstName: { value: 'armin', type: 'text', name: 'firstName' }, lastName: { value: 'armin', type: 'text', name: 'lastName' } }, d = { fromDate: { value: '2020-2-2 00:00', type: 'text', name: 'fromDate' }, toDate: { value: '', type: 'text', name: 'toDate' }, status: { value: '', options: [{ value: 1, label: 'accepted' }, { value: 2, label: 'rejected' }], name: 'status' } }, s = [{ renderer: a.mapIntoTD([{ input: o.formNumberInput(i.formNumber) }, { input: o.firstNameInput(i.firstName) }, { input: o.lastNameInput(i.lastName) }]) }, { renderer: a.mapIntoTD([{ input: o.fromDateInput(d.fromDate) }, { input: o.toDateInput(d.toDate) }, { input: o.statusInput(d.status) }]) }];
        window.DynamicDataTable = a['default'];
    }, "./src/utils.ts": /*!**********************!*\
    !*** ./src/utils.ts ***!
    \**********************/ /*! no static exports found */ function (e, t, n) {
        'use strict';
