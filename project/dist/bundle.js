...
(function (modules) { function __webpack_require__(moduleId) { if (installedModules[moduleId])
    ...
    \*********************/ /*! no static exports found */ function (module, exports, __webpack_require__) {
        ...
        exports.__esModule = !0;
        var anotherGrid_1 = __webpack_require__(/*! ./anotherGrid */ './src/anotherGrid.ts'), library = window.Didgah4DynamicDataLibrary, grid = library.DynamicDataGrid({ currentDocument: window.document, headers: ['countryname', 'date', 'grid1'], initialFormData: [{ countryname: 'netherlands', countrycode: '', grid1: [{ a: 'Armin' }] }], displayCellRenderer: function (d) { return { input: library.createElement({ tagName: 'span', props: { id: 'grid1' === d.name ? 'from-date-datePicker' : '', style: { width: '240px' } }, onMount: function () { window.document.getElementById('from-date-datePicker').innerHTML = '<input type=\'text\' style=\'display:none;\' id=\'txt123456\' name="' + (d.name || '') + '" value="' + (d.value || '') + '" /><ccc:datePicker showTime=\'true\' forceShowTime=\'true\'/>'; } }), cellProps: { colSpan: d.col } }; }, editCellRenderer: function (d) { return d.Type.IsBundle ? { input: library.DynamicDataGrid(__assign(__assign({}, anotherGrid_1['default']), { onUpdateFormData: d.onUpdateFormData })), cellProps: { colSpan: d.col } } : { input: library.withLabel(library.createElement({ tagName: 'input' }), d.name), cellProps: { colSpan: d.col } }; }, rowsData: { fields: [{ name: 'countryname', col: 1, Type: { IsBundle: !1 } }, { name: 'date', col: 3, Type: { IsBundle: !1 } }, { name: 'grid1', col: 1, Type: { IsBundle: !0 } }] } });
