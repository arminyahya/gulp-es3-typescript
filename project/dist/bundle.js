...
(function (a) { function b(d) { if (c[d])
    ...
    for (var e in a)
      ...
      \****************************/ /*! no static exports found */ function (a, b) {
        'use strict';
        b.__esModule = !0, b['default'] = function () { return { headers: ['a'], initialFormData: [{ a: 'Armin' }], displayCellRenderer: function (a) { return { input: function () { return window.Didgah4DynamicDataLibrary.createElement({ currentDocument: a.currentDocument, tagName: 'input', props: { value: a.formData, disabled: !0 } }); }, cellProps: { colSpan: a.col } }; }, editCellRenderer: function (a) { return { input: function () { return window.Didgah4DynamicDataLibrary.withLabel(window.Didgah4DynamicDataLibrary.createElement({ tagName: 'input', props: { value: a.formData || '', fieldName: a.name } }), a.name); }, cellProps: { colSpan: a.col } }; }, rowsData: { fields: [{ name: 'a', col: 1, Type: { IsBundle: !1 } }] } }; };
    }, "./src/main.ts": /*!*********************!*\
    !*** ./src/main.ts ***!
