...
(function (modules) { function __webpack_require__(moduleId) { if (installedModules[moduleId])
    ...
    for (var key in value)
      ...
      \********************************/ /*! no static exports found */ function (module, exports) {
        ...
        \****************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { var __awaiter = this && this.__awaiter || function (thisArg, _arguments, P, generator) { function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); } return new (P || (P = Promise))(function (resolve, reject) { function fulfilled(value) { try {
            ...
            } }; }, exports.formToJSON = function (selector) { var form = {}; return document.querySelectorAll(selector + ' input').forEach(function (el) { var name = el.getAttribute('fieldName'); name && (form[name] = el.getAttribute('value')); }), form; }, exports.dialogFormToJSON = function () { var form = {}; return $('input[type="text"]').each(function () { var self = $(this), name = self.attr('fieldName'); form[name] = form[name] ? form[name] + ',' + self.val() : self.val(); }), form; }, exports.importModule = function (url) { var refinedUrl = url; return new Promise(function (resolve, reject) { var script = document.createElement('script'); script.src = refinedUrl, script.async = !0, script.onload = function () { resolve(), script.remove(); }, script.onerror = function () { reject(new Error('Failed to load module script with URL ' + refinedUrl)), script.remove(); }, document.head.appendChild(script); }); }; }, 0: /*!****************************!*\
            !*** multi ./src/index.ts ***!
    ...
    \****************************/ /*! no static exports found */ function (module, exports, __webpack_require__) {
        ...
        exports['default'] = { headers: ['field0'], displayCellRenderer: function (d) { return { input: lib.createElement({ tagName: 'input', props: { fieldName: d.name, onclick: function () { } } }), cellProps: { colSpan: d.col } }; }, editCellRenderer: function (d) { return { input: lib.createElement({ tagName: 'input', props: { value: d.formData || '', fieldName: d.name } }), cellProps: { colSpan: d.col } }; }, rowsData: { fields: [{ name: 'field0', col: 1, Type: { IsBundle: !1 } }] } };
    }, "./src/main.ts": /*!*********************!*\
    !*** ./src/main.ts ***!
    \*********************/ /*! no static exports found */ function (module, exports, __webpack_require__) {
        'use strict';
