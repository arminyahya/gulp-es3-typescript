...
(function () {
    try {
        ...
        if (!hasDp || isIE8) {
            ...
            var oldDp_2 = Object.defineProperty;
            Object.defineProperty = function (object, property, descriptor) {
                ...
                return oldDp_2(object, property, descriptor2Use);
            };
        }
    }
})();
      ...
      \********************************/ /*! no static exports found */ function (module, exports) {
        ...
        var __assign = function () { return __assign = Object.assign || function (t) { for (var s, i = 1, n = arguments.length; i < n; i++)
            for (var p in s = arguments[i], s)
                Object.prototype.hasOwnProperty.call(s, p) && (t[p] = s[p]); return t; }, __assign.apply(this, arguments); };
        (function () { try {
            var result = Object.defineProperty({}, 'a', { get: function () { return 1; } });
            if (1 !== result.a)
                throw new Error('fail');
        }
        catch (e) {
            ...
            try {
                var div = document.createElement('a');
                isIE8 = 1 === Object.defineProperty(div, 'a', { value: 1 }).a;
            }
            catch (e) { }
            var hasDp = 'defineProperty' in Object;
            if (!hasDp || isIE8)
                Object.defineProperty = function (object, property, descriptor) { return void 0 === object && (object = {}), void 0 === property && (property = 'property'), void 0 === descriptor && (descriptor = {}), 'value' in descriptor ? object[property] = descriptor.value : 'get' in descriptor && (object[property] = descriptor.get()), object; };
            else {
                var oldDp_1 = Object.defineProperty;
                Object.defineProperty = function (object, property, descriptor) { var descriptor2Use = descriptor; if ('get' in descriptor) {
                    var value = descriptor.get();
                    delete descriptor.get, descriptor2Use = __assign(__assign({}, descriptor), { value: value });
                } return oldDp_1(object, property, descriptor2Use); };
            }
        } })(), exports.lib = function (modules) { function __webpack_require__(moduleId) { if (installedModules[moduleId])
            return installedModules[moduleId].exports; var module = installedModules[moduleId] = { i: moduleId, l: !1, exports: {} }; return modules[moduleId].call(module.exports, module, module.exports, __webpack_require__), module.l = !0, module.exports; } var installedModules = {}; return __webpack_require__.m = modules, __webpack_require__.c = installedModules, __webpack_require__.d = function (exports, name, getter) { __webpack_require__.o(exports, name) || Object.defineProperty(exports, name, { enumerable: !0, get: getter }); }, __webpack_require__.r = function (exports) { 'undefined' != typeof Symbol && Symbol.toStringTag && Object.defineProperty(exports, Symbol.toStringTag, { value: 'Module' }), Object.defineProperty(exports, '__esModule', { value: !0 }); }, __webpack_require__.t = function (value, mode) { if (1 & mode && (value = __webpack_require__(value)), 8 & mode)
            return value; if (4 & mode && 'object' == _typeof(value) && value && value.__esModule)
            return value; var ns = Object.create(null); if (__webpack_require__.r(ns), Object.defineProperty(ns, 'default', { enumerable: !0, value: value }), 2 & mode && 'string' != typeof value)
            for (var key in value)
            ...
            \********************************************/ /*! no static exports found */ function (module, exports) {
                var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__; /*!
                  ...
                  */
                (function (global, factory) { 'object' == _typeof(module.exports) ? module.exports = global.document ? factory(global, !0) : function (w) { if (!w.document)
                    ...
                    function internalData(elem, name, data, pvt) { if (acceptData(elem)) {
                        ...
                        if (id && cache[id] && (pvt || cache[id].data) || void 0 !== data || 'string' != typeof name)
                            return id || (isNode ? id = elem[internalKey] = deletedIds.pop() || jQuery.guid++ : id = internalKey), cache[id] || (cache[id] = isNode ? {} : { toJSON: jQuery.noop }), ('object' == _typeof(name) || 'function' == typeof name) && (pvt ? cache[id] = jQuery.extend(cache[id], name) : cache[id].data = jQuery.extend(cache[id].data, name)), thisCache = cache[id], pvt || (!thisCache.data && (thisCache.data = {}), thisCache = thisCache.data), void 0 !== data && (thisCache[jQuery.camelCase(name)] = data), 'string' == typeof name ? (ret = thisCache[name], null == ret && (ret = thisCache[jQuery.camelCase(name)])) : ret = thisCache, ret;
                    } }
                    ...
                    function getAll(context, tag) { var elems, elem, i = 0, found = 'undefined' == typeof context.getElementsByTagName ? 'undefined' == typeof context.querySelectorAll ? void 0 : context.querySelectorAll(tag || '*') : context.getElementsByTagName(tag || '*'); if (!found)
                    ...
                    function buildFragment(elems, context, scripts, selection, ignored) { for (var j, elem, contains, tmp, tag, tbody, wrap, l = elems.length, safe = createSafeFragment(context), nodes = [], i = 0; i < l; i++)
                    ...
                    function _on(elem, types, selector, data, fn, one) { var origFn, type; if ('object' == _typeof(types)) {
                    ...
                    function domManip(collection, args, callback, ignored) { args = concat.apply([], args); var first, node, hasScripts, scripts, doc, fragment, i = 0, l = collection.length, value = args[0], isFunction = jQuery.isFunction(value); if (isFunction || 1 < l && 'string' == typeof value && !support.checkClone && rchecked.test(value))
                    ...
                    function _remove(elem, selector, keepData) { for (var node, elems = selector ? jQuery.filter(selector, elem) : elem, i = 0; null != (node = elems[i]); i++)
                    ...
                    function vendorPropName(name) { if (name in emptyStyle)
                        ...
                        if (name = cssPrefixes[i] + capName, name in emptyStyle)
                            return name; }
                    function showHide(elements, show) { for (var display, elem, hidden, values = [], index = 0, length = elements.length; index < length; index++)
                    ...
                    function genFx(type, includeWidth) { var which, attrs = { height: type }, i = 0; for (includeWidth = includeWidth ? 1 : 0; 4 > i; i += 2 - includeWidth)
                    ...
                    function Animation(elem, properties, options) { var result, stopped, index = 0, length = Animation.prefilters.length, deferred = jQuery.Deferred().always(function () { delete tick.elem; }), tick = function () { if (stopped)
                        ...
                        animation.tweens[index].run(percent); return deferred.notifyWith(elem, [animation, percent, remaining]), 1 > percent && length ? remaining : (deferred.resolveWith(elem, [animation]), !1); }, animation = deferred.promise({ elem: elem, props: jQuery.extend({}, properties), opts: jQuery.extend(!0, { specialEasing: {}, easing: jQuery.easing._default }, options), originalProperties: properties, originalOptions: options, startTime: fxNow || createFxNow(), duration: options.duration, tweens: [], createTween: function (prop, end) { var tween = jQuery.Tween(elem, animation.opts, prop, end, animation.opts.specialEasing[prop] || animation.opts.easing); return animation.tweens.push(tween), tween; }, stop: function (gotoEnd) { var index = 0, length = gotoEnd ? animation.tweens.length : 0; if (stopped)
                            ...
                            animation.tweens[index].run(1); return gotoEnd ? (deferred.notifyWith(elem, [animation, 1, 0]), deferred.resolveWith(elem, [animation, gotoEnd])) : deferred.rejectWith(elem, [animation, gotoEnd]), this; } }), props = animation.props; for (propFilter(props, animation.opts.specialEasing); index < length; index++)
                    ...
                    function addToPrefiltersOrTransports(structure) { return function (dataTypeExpression, func) { 'string' != typeof dataTypeExpression && (func = dataTypeExpression, dataTypeExpression = '*'); var dataType, i = 0, dataTypes = dataTypeExpression.toLowerCase().match(rnotwhite) || []; if (jQuery.isFunction(func))
                    ...
                    function ajaxHandleResponses(s, jqXHR, responses) { for (var firstDataType, ct, finalDataType, type, contents = s.contents, dataTypes = s.dataTypes; '*' === dataTypes[0];)
                    ...
                    function buildParams(prefix, obj, traditional, add) { if (jQuery.isArray(obj))
                        jQuery.each(obj, function (i, v) { traditional || rbracket.test(prefix) ? add(prefix, v) : buildParams(prefix + '[' + ('object' == _typeof(v) && null != v ? i : '') + ']', v, traditional, add); });
                    ...
                    var _Mathmax = Math.max, deletedIds = [], document = window.document, _slice = deletedIds.slice, concat = deletedIds.concat, push = deletedIds.push, indexOf = deletedIds.indexOf, class2type = {}, toString = class2type.toString, hasOwn = class2type.hasOwnProperty, support = {}, version = '1.12.4', jQuery = function jQuery(selector, context) { return new jQuery.fn.init(selector, context); }, rtrim = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, rmsPrefix = /^-ms-/, rdashAlpha = /-([\da-z])/gi, fcamelCase = function (all, letter) { return letter.toUpperCase(); };
                    jQuery.fn = jQuery.prototype = { jquery: version, constructor: jQuery, selector: '', length: 0, toArray: function () { return _slice.call(this); }, get: function (num) { return null == num ? _slice.call(this) : 0 > num ? this[num + this.length] : this[num]; }, pushStack: function (elems) { var ret = jQuery.merge(this.constructor(), elems); return ret.prevObject = this, ret.context = this.context, ret; }, each: function (callback) { return jQuery.each(this, callback); }, map: function (callback) { return this.pushStack(jQuery.map(this, function (elem, i) { return callback.call(elem, i, elem); })); }, slice: function () { return this.pushStack(_slice.apply(this, arguments)); }, first: function () { return this.eq(0); }, last: function () { return this.eq(-1); }, eq: function (i) { var len = this.length, j = +i + (0 > i ? len : 0); return this.pushStack(0 <= j && j < len ? [this[j]] : []); }, end: function () { return this.prevObject || this.constructor(); }, push: push, sort: deletedIds.sort, splice: deletedIds.splice }, jQuery.extend = jQuery.fn.extend = function () { var src, copyIsArray, copy, name, options, clone, target = arguments[0] || {}, i = 1, length = arguments.length, deep = !1; for ('boolean' == typeof target && (deep = target, target = arguments[i] || {}, i++), 'object' == _typeof(target) || jQuery.isFunction(target) || (target = {}), i === length && (target = this, i--); i < length; i++)
                        if (null != (options = arguments[i]))
                            ...
                            ; return void 0 == key || hasOwn.call(obj, key); }, type: function (obj) { return null == obj ? obj + '' : 'object' == _typeof(obj) || 'function' == typeof obj ? class2type[toString.call(obj)] || 'object' : _typeof(obj); }, globalEval: function (data) { data && jQuery.trim(data) && (window.execScript || function (data) { window.eval.call(window, data); })(data); }, camelCase: function (string) { return string.replace(rmsPrefix, 'ms-').replace(rdashAlpha, fcamelCase); }, nodeName: function (elem, name) { return elem.nodeName && elem.nodeName.toLowerCase() === name.toLowerCase(); }, each: function (obj, callback) { var length, i = 0; if (isArrayLike(obj))
                            ...
                            for (; void 0 !== second[j];)
                                first[i++] = second[j++]; return first.length = i, first; }, grep: function (elems, callback, invert) { for (var callbackInverse, matches = [], i = 0, length = elems.length; i < length; i++)
                            callbackInverse = !callback(elems[i], i), callbackInverse != !invert && matches.push(elems[i]); return matches; }, map: function (elems, callback, arg) { var length, value, i = 0, ret = []; if (isArrayLike(elems))
                            ...
                            return args = _slice.call(arguments, 2), proxy = function () { return fn.apply(context || this, args.concat(_slice.call(arguments))); }, proxy.guid = fn.guid = fn.guid || jQuery.guid++, proxy; }, now: function () { return +new Date; }, support: support }), 'function' == typeof Symbol && (jQuery.fn[Symbol.iterator] = deletedIds[Symbol.iterator]), jQuery.each(['Boolean', 'Number', 'String', 'Function', 'Array', 'Date', 'RegExp', 'Object', 'Error', 'Symbol'], function (i, name) { class2type['[object ' + name + ']'] = name.toLowerCase(); });
                    var Sizzle = /*!
                      ...
                      *
                      * Date: 2015-10-17
                      */ function (window) { function Sizzle(selector, context, results, seed) { var m, i, elem, nid, nidselect, match, groups, newSelector, newContext = context && context.ownerDocument, nodeType = context ? context.nodeType : 9; if (results = results || [], 'string' != typeof selector || !selector || 1 !== nodeType && 9 !== nodeType && 11 !== nodeType)
                        ...
                        for (; cur = cur.nextSibling;)
                            if (cur === b)
                                return -1; return a ? 1 : -1; } function createInputPseudo(type) { return function (elem) { var name = elem.nodeName.toLowerCase(); return 'input' === name && elem.type === type; }; } function createButtonPseudo(type) { return function (elem) { var name = elem.nodeName.toLowerCase(); return ('input' === name || 'button' === name) && elem.type === type; }; } function createPositionalPseudo(fn) { return markFunction(function (argument) { return argument = +argument, markFunction(function (seed, matches) { for (var j, matchIndexes = fn([], seed.length, argument), i = matchIndexes.length; i--;)
                        ...
                        if (1 === elem.nodeType || checkNonElements)
                            return matcher(elem, context, xml); } : function (elem, context, xml) { var oldCache, uniqueCache, outerCache, newCache = [dirruns, doneName]; if (xml) {
                        for (; elem = elem[dir];)
                        ...
                        Sizzle(selector, contexts[i], results); return results; } function condense(unmatched, map, filter, context, xml) { for (var elem, newUnmatched = [], i = 0, len = unmatched.length; i < len; i++)
                        ...
                        } return elementMatcher(matchers); } function matcherFromGroupMatchers(elementMatchers, setMatchers) { var bySet = 0 < setMatchers.length, byElement = 0 < elementMatchers.length, superMatcher = function (seed, context, xml, results, outermost) { var elem, j, matcher, matchedCount = 0, i = '0', unmatched = seed && [], setMatched = [], contextBackup = outermostContext, elems = seed || byElement && Expr.find.TAG('*', outermost), dirrunsUnique = dirruns += null == contextBackup ? 1 : Math.random() || .1, len = elems.length; for (outermost && (outermostContext = context === document || context || outermost); i !== len && null != (elem = elems[i]); i++) {
                        if (byElement && elem) {
                        ...
                        return hasDuplicate = !0, 0; var cur, i = 0, aup = a.parentNode, bup = b.parentNode, ap = [a], bp = [b]; if (!aup || !bup)
                        ...
                        return elem.nodeValue; return ret; }, Expr = Sizzle.selectors = { cacheLength: 50, createPseudo: markFunction, match: matchExpr, attrHandle: {}, find: {}, relative: { ">": { dir: 'parentNode', first: !0 }, " ": { dir: 'parentNode' }, "+": { dir: 'previousSibling', first: !0 }, "~": { dir: 'previousSibling' } }, preFilter: { ATTR: function (match) { return match[1] = match[1].replace(runescape, funescape), match[3] = (match[3] || match[4] || match[5] || '').replace(runescape, funescape), '~=' === match[2] && (match[3] = ' ' + match[3] + ' '), match.slice(0, 4); }, CHILD: function (match) { return match[1] = match[1].toLowerCase(), 'nth' === match[1].slice(0, 3) ? (!match[3] && Sizzle.error(match[0]), match[4] = +(match[4] ? match[5] + (match[6] || 1) : 2 * ('even' === match[3] || 'odd' === match[3])), match[5] = +(match[7] + match[8] || 'odd' === match[3])) : match[3] && Sizzle.error(match[0]), match; }, PSEUDO: function (match) { var excess, unquoted = !match[6] && match[2]; return matchExpr.CHILD.test(match[0]) ? null : (match[3] ? match[2] = match[4] || match[5] || '' : unquoted && rpseudo.test(unquoted) && (excess = tokenize(unquoted, !0)) && (excess = unquoted.indexOf(')', unquoted.length - excess) - unquoted.length) && (match[0] = match[0].slice(0, excess), match[2] = unquoted.slice(0, excess)), match.slice(0, 3)); } }, filter: { TAG: function (nodeNameSelector) { var nodeName = nodeNameSelector.replace(runescape, funescape).toLowerCase(); return '*' === nodeNameSelector ? function () { return !0; } : function (elem) { return elem.nodeName && elem.nodeName.toLowerCase() === nodeName; }; }, CLASS: function (className) { var pattern = classCache[className + ' ']; return pattern || (pattern = new RegExp('(^|' + whitespace + ')' + className + '(' + whitespace + '|$)')) && classCache(className, function (elem) { return pattern.test('string' == typeof elem.className && elem.className || 'undefined' != typeof elem.getAttribute && elem.getAttribute('class') || ''); }); }, ATTR: function (name, operator, check) { return function (elem) { var result = Sizzle.attr(elem, name); return null == result ? '!=' === operator : !operator || (result += '', '=' === operator ? result === check : '!=' === operator ? result !== check : '^=' === operator ? check && 0 === result.indexOf(check) : '*=' === operator ? check && -1 < result.indexOf(check) : '$=' === operator ? check && result.slice(-check.length) === check : '~=' === operator ? -1 < (' ' + result.replace(rwhitespace, ' ') + ' ').indexOf(check) : '|=' == operator && (result === check || result.slice(0, check.length + 1) === check + '-')); }; }, CHILD: function (type, what, argument, first, last) { var simple = 'nth' !== type.slice(0, 3), forward = 'last' !== type.slice(-4), ofType = 'of-type' === what; return 1 === first && 0 === last ? function (elem) { return !!elem.parentNode; } : function (elem, context, xml) { var cache, uniqueCache, outerCache, node, nodeIndex, start, dir = simple == forward ? 'previousSibling' : 'nextSibling', parent = elem.parentNode, name = ofType && elem.nodeName.toLowerCase(), useCache = !xml && !ofType, diff = !1; if (parent) {
                            ...
                            } }; }, PSEUDO: function (pseudo, argument) { var args, fn = Expr.pseudos[pseudo] || Expr.setFilters[pseudo.toLowerCase()] || Sizzle.error('unsupported pseudo: ' + pseudo); return fn[expando] ? fn(argument) : 1 < fn.length ? (args = [pseudo, pseudo, '', argument], Expr.setFilters.hasOwnProperty(pseudo.toLowerCase()) ? markFunction(function (seed, matches) { for (var idx, matched = fn(seed, argument), i = matched.length; i--;)
                                idx = indexOf(seed, matched[i]), seed[idx] = !(matches[idx] = matched[i]); }) : function (elem) { return fn(elem, 0, args); }) : fn; } }, pseudos: { not: markFunction(function (selector) { var input = [], results = [], matcher = compile(selector.replace(rtrim, '$1')); return matcher[expando] ? markFunction(function (seed, matches, context, xml) { for (var elem, unmatched = matcher(seed, null, xml, []), i = seed.length; i--;)
                        ...
                        Expr.pseudos[i] = createButtonPseudo(i); return setFilters.prototype = Expr.filters = Expr.pseudos, Expr.setFilters = new setFilters, tokenize = Sizzle.tokenize = function (selector, parseOnly) { var matched, match, tokens, type, soFar, groups, preFilters, cached = tokenCache[selector + ' ']; if (cached)
                        ...
                        if (!matched)
                            break;
                    } return parseOnly ? soFar.length : soFar ? Sizzle.error(selector) : tokenCache(selector, groups).slice(0); }, compile = Sizzle.compile = function (selector, match) { var i, setMatchers = [], elementMatchers = [], cached = compilerCache[selector + ' ']; if (!cached) {
                    ...
                    } return cached; }, select = Sizzle.select = function (selector, context, results, seed) { var i, tokens, token, type, find, compiled = 'function' == typeof selector && selector, match = !seed && tokenize(selector = compiled.selector || selector); if (results = results || [], 1 === match.length) {
                    ...
                    var dir = function (elem, _dir, until) { for (var matched = []; (elem = elem[_dir]) && 9 !== elem.nodeType;)
                        if (1 === elem.nodeType) {
                            if (void 0 !== until && jQuery(elem).is(until))
                                break;
                            matched.push(elem);
                        } return matched; }, _siblings = function (n, elem) { for (var matched = []; n; n = n.nextSibling)
                    ...
                    var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, init = jQuery.fn.init = function (selector, context, root) { var match, elem; if (!selector)
                    ...
                    } return selector.nodeType ? (this.context = this[0] = selector, this.length = 1, this) : jQuery.isFunction(selector) ? 'undefined' == typeof root.ready ? selector(jQuery) : root.ready(selector) : (void 0 !== selector.selector && (this.selector = selector.selector, this.context = selector.context), jQuery.makeArray(selector, this)); };
                    init.prototype = jQuery.fn, rootjQuery = jQuery(document);
                    var rparentsprev = /^(?:parents|prev(?:Until|All))/, guaranteedUnique = { children: !0, contents: !0, next: !0, prev: !0 };
                    jQuery.fn.extend({ has: function (target) { var i, targets = jQuery(target, this), len = targets.length; return this.filter(function () { for (i = 0; i < len; i++)
                    ...
                    var rnotwhite = /\S+/g;
                    jQuery.Callbacks = function (options) { options = 'string' == typeof options ? createOptions(options) : jQuery.extend({}, options); var firing, memory, _fired, _locked, list = [], queue = [], firingIndex = -1, fire = function () { for (_locked = options.once, _fired = firing = !0; queue.length; firingIndex = -1)
                        for (memory = queue.shift(); ++firingIndex < list.length;)
                            !1 === list[firingIndex].apply(memory[0], memory[1]) && options.stopOnFalse && (firingIndex = list.length, memory = !1); options.memory || (memory = !1), firing = !1, _locked && (memory ? list = [] : list = ''); }, self = { add: function () { return list && (memory && !firing && (firingIndex = list.length - 1, queue.push(memory)), function add(args) { jQuery.each(args, function (_, arg) { jQuery.isFunction(arg) ? (!options.unique || !self.has(arg)) && list.push(arg) : arg && arg.length && 'string' !== jQuery.type(arg) && add(arg); }); }(arguments), memory && !firing && fire()), this; }, remove: function () { return jQuery.each(arguments, function (_, arg) { for (var index; -1 < (index = jQuery.inArray(arg, list, index));)
                            list.splice(index, 1), index <= firingIndex && firingIndex--; }), this; }, has: function (fn) { return fn ? -1 < jQuery.inArray(fn, list) : 0 < list.length; }, empty: function () { return list && (list = []), this; }, disable: function () { return _locked = queue = [], list = memory = '', this; }, disabled: function () { return !list; }, lock: function () { return _locked = !0, memory || self.disable(), this; }, locked: function () { return !!_locked; }, fireWith: function (context, args) { return _locked || (args = args || [], args = [context, args.slice ? args.slice() : args], queue.push(args), !firing && fire()), this; }, fire: function () { return self.fireWith(this, arguments), this; }, fired: function () { return !!_fired; } }; return self; }, jQuery.extend({ Deferred: function (func) { var tuples = [['resolve', 'done', jQuery.Callbacks('once memory'), 'resolved'], ['reject', 'fail', jQuery.Callbacks('once memory'), 'rejected'], ['notify', 'progress', jQuery.Callbacks('memory')]], _state = 'pending', _promise = { state: function () { return _state; }, always: function () { return deferred.done(arguments).fail(arguments), this; }, then: function () { var fns = arguments; return jQuery.Deferred(function (newDefer) { jQuery.each(tuples, function (i, tuple) { var fn = jQuery.isFunction(fns[i]) && fns[i]; deferred[tuple[1]](function () { var returned = fn && fn.apply(this, arguments); returned && jQuery.isFunction(returned.promise) ? returned.promise().progress(newDefer.notify).done(newDefer.resolve).fail(newDefer.reject) : newDefer[tuple[0] + 'With'](this === _promise ? newDefer.promise() : this, fn ? [returned] : arguments); }); }), fns = null; }).promise(); }, promise: function (obj) { return null == obj ? _promise : jQuery.extend(obj, _promise); } }, deferred = {}; return _promise.pipe = _promise.then, jQuery.each(tuples, function (i, tuple) { var list = tuple[2], stateString = tuple[3]; _promise[tuple[1]] = list.add, stateString && list.add(function () { _state = stateString; }, tuples[1 ^ i][2].disable, tuples[2][2].lock), deferred[tuple[0]] = function () { return deferred[tuple[0] + 'With'](this === deferred ? _promise : this, arguments), this; }, deferred[tuple[0] + 'With'] = list.fireWith; }), _promise.promise(deferred), func && func.call(deferred, deferred), deferred; }, when: function (subordinate) { var progressValues, progressContexts, resolveContexts, i = 0, resolveValues = _slice.call(arguments), length = resolveValues.length, remaining = 1 !== length || subordinate && jQuery.isFunction(subordinate.promise) ? length : 0, deferred = 1 === remaining ? subordinate : jQuery.Deferred(), updateFunc = function (i, contexts, values) { return function (value) { contexts[i] = this, values[i] = 1 < arguments.length ? _slice.call(arguments) : value, values === progressValues ? deferred.notifyWith(contexts, values) : !--remaining && deferred.resolveWith(contexts, values); }; }; if (1 < length)
                    ...
                    var readyList;
                    for (var i in jQuery.fn.ready = function (fn) { return jQuery.ready.promise().done(fn), this; }, jQuery.extend({ isReady: !1, readyWait: 1, holdReady: function (hold) { hold ? jQuery.readyWait++ : jQuery.ready(!0); }, ready: function (wait) { (!0 === wait ? !--jQuery.readyWait : !jQuery.isReady) && (jQuery.isReady = !0, !0 !== wait && 0 < --jQuery.readyWait || (readyList.resolveWith(document, [jQuery]), jQuery.fn.triggerHandler && (jQuery(document).triggerHandler('ready'), jQuery(document).off('ready')))); } }), jQuery.ready.promise = function (obj) { if (!readyList)
                        ...
                        } return readyList.promise(obj); }, jQuery.ready.promise(), jQuery(support))
                        break;
                    ...
                    (function () { var i, eventName, div = document.createElement('div'); for (i in { submit: !0, change: !0, focusin: !0 })
                    ...
                    jQuery.event = { global: {}, add: function (elem, types, handler, data, selector) { var tmp, events, t, handleObjIn, special, eventHandle, handleObj, handlers, type, namespaces, origType, elemData = jQuery._data(elem); if (elemData) {
                            ...
                            elem = null;
                        } }, remove: function (elem, types, handler, selector, mappedTypes) { var j, handleObj, tmp, origCount, t, events, special, handlers, type, namespaces, origType, elemData = jQuery.hasData(elem) && jQuery._data(elem); if (elemData && (events = elemData.events)) {
                        ...
                        } }, handlers: function (event, _handlers) { var i, matches, sel, handleObj, handlerQueue = [], delegateCount = _handlers.delegateCount, cur = event.target; if (delegateCount && cur.nodeType && ('click' !== event.type || isNaN(event.button) || 1 > event.button))
                            for (; cur != this; cur = cur.parentNode || this)
                                if (1 === cur.nodeType && (!0 !== cur.disabled || 'click' !== event.type)) {
                                    for (matches = [], i = 0; i < delegateCount; i++)
                                        handleObj = _handlers[i], sel = handleObj.selector + ' ', void 0 === matches[sel] && (matches[sel] = handleObj.needsContext ? -1 < jQuery(sel, this).index(cur) : jQuery.find(sel, this, null, [cur]).length), matches[sel] && matches.push(handleObj);
                                    matches.length && handlerQueue.push({ elem: cur, handlers: matches });
                                } return delegateCount < _handlers.length && handlerQueue.push({ elem: this, handlers: _handlers.slice(delegateCount) }), handlerQueue; }, fix: function (event) { if (event[jQuery.expando])
                            return event; var i, prop, copy, type = event.type, originalEvent = event, fixHook = this.fixHooks[type]; for (fixHook || (this.fixHooks[type] = fixHook = rmouseEvent.test(type) ? this.mouseHooks : rkeyEvent.test(type) ? this.keyHooks : {}), copy = fixHook.props ? this.props.concat(fixHook.props) : this.props, event = new jQuery.Event(originalEvent), i = copy.length; i--;)
                            prop = copy[i], event[prop] = originalEvent[prop]; return event.target || (event.target = originalEvent.srcElement || document), 3 === event.target.nodeType && (event.target = event.target.parentNode), event.metaKey = !!event.metaKey, fixHook.filter ? fixHook.filter(event, originalEvent) : event; }, props: ['altKey', 'bubbles', 'cancelable', 'ctrlKey', 'currentTarget', 'detail', 'eventPhase', 'metaKey', 'relatedTarget', 'shiftKey', 'target', 'timeStamp', 'view', 'which'], fixHooks: {}, keyHooks: { props: ['char', 'charCode', 'key', 'keyCode'], filter: function (event, original) { return null == event.which && (event.which = null == original.charCode ? original.keyCode : original.charCode), event; } }, mouseHooks: { props: ['button', 'buttons', 'clientX', 'clientY', 'fromElement', 'offsetX', 'offsetY', 'pageX', 'pageY', 'screenX', 'screenY', 'toElement'], filter: function (event, original) { var body, eventDoc, doc, button = original.button, fromElement = original.fromElement; return null == event.pageX && null != original.clientX && (eventDoc = event.target.ownerDocument || document, doc = eventDoc.documentElement, body = eventDoc.body, event.pageX = original.clientX + (doc && doc.scrollLeft || body && body.scrollLeft || 0) - (doc && doc.clientLeft || body && body.clientLeft || 0), event.pageY = original.clientY + (doc && doc.scrollTop || body && body.scrollTop || 0) - (doc && doc.clientTop || body && body.clientTop || 0)), !event.relatedTarget && fromElement && (event.relatedTarget = fromElement === event.target ? original.toElement : fromElement), event.which || void 0 === button || (event.which = 1 & button ? 1 : 2 & button ? 3 : 4 & button ? 2 : 0), event; } }, special: { load: { noBubble: !0 }, focus: { trigger: function () { if (this !== safeActiveElement() && this.focus)
                                    try {
                                        return this.focus(), !1;
                                    }
                            ...
                            return handleObj = types.handleObj, jQuery(types.delegateTarget).off(handleObj.namespace ? handleObj.origType + '.' + handleObj.namespace : handleObj.origType, handleObj.selector, handleObj.handler), this; if ('object' == _typeof(types)) {
                            for (type in types)
                    ...
                    jQuery.extend({ htmlPrefilter: function (html) { return html.replace(rxhtmlTag, '<$1></$2>'); }, clone: function (elem, dataAndEvents, deepDataAndEvents) { var destElements, node, clone, i, srcElements, inPage = jQuery.contains(elem.ownerDocument, elem); if (support.html5Clone || jQuery.isXMLDoc(elem) || !rnoshimcache.test('<' + elem.nodeName + '>') ? clone = elem.cloneNode(!0) : (fragmentDiv.innerHTML = elem.outerHTML, fragmentDiv.removeChild(clone = fragmentDiv.firstChild)), (!support.noCloneEvent || !support.noCloneChecked) && (1 === elem.nodeType || 11 === elem.nodeType) && !jQuery.isXMLDoc(elem))
                        ...
                        } }); }, before: function () { return domManip(this, arguments, function (elem) { this.parentNode && this.parentNode.insertBefore(elem, this); }); }, after: function () { return domManip(this, arguments, function (elem) { this.parentNode && this.parentNode.insertBefore(elem, this.nextSibling); }); }, empty: function () { for (var elem, i = 0; null != (elem = this[i]); i++) {
                    ...
                    jQuery.extend({ cssHooks: { opacity: { get: function (elem, computed) { if (computed) {
                            ...
                            if (name = jQuery.cssProps[origName] || (jQuery.cssProps[origName] = vendorPropName(origName) || origName), hooks = jQuery.cssHooks[name] || jQuery.cssHooks[origName], void 0 !== value) {
                                if (type = _typeof(value), 'string' === type && (ret = rcssNum.exec(value)) && ret[1] && (value = adjustCSS(elem, name, ret), type = 'number'), null == value || value !== value)
                                    return;
                        ...
                        return (parseFloat(curCSS(elem, 'marginLeft')) || (jQuery.contains(elem.ownerDocument, elem) ? elem.getBoundingClientRect().left - swap(elem, { marginLeft: 0 }, function () { return elem.getBoundingClientRect().left; }) : 0)) + 'px'; }), jQuery.each({ margin: '', padding: '', border: 'Width' }, function (prefix, suffix) { jQuery.cssHooks[prefix + suffix] = { expand: function (value) { for (var i = 0, expanded = {}, parts = 'string' == typeof value ? value.split(' ') : [value]; 4 > i; i++)
                            expanded[prefix + cssExpand[i] + suffix] = parts[i] || parts[i - 2] || parts[0]; return expanded; } }, rmargin.test(prefix) || (jQuery.cssHooks[prefix + suffix].set = setPositiveNumber); }), jQuery.fn.extend({ css: function (name, value) { return access(this, function (elem, name, value) { var styles, len, map = {}, i = 0; if (jQuery.isArray(name)) {
                    ...
                    jQuery.Animation = jQuery.extend(Animation, { tweeners: { "*": [function (prop, value) { var tween = this.createTween(prop, value); return adjustCSS(tween.elem, prop, rcssNum.exec(value), tween), tween; }] }, tweener: function (props, callback) { jQuery.isFunction(props) ? (callback = props, props = ['*']) : props = props.match(rnotwhite); for (var prop, index = 0, length = props.length; index < length; index++)
                            ...
                            timers[index].elem === this && (null == type || timers[index].queue === type) && (timers[index].anim.stop(gotoEnd), dequeue = !1, timers.splice(index, 1)); (dequeue || !gotoEnd) && jQuery.dequeue(this, type); }); }, finish: function (type) { return !1 !== type && (type = type || 'fx'), this.each(function () { var index, data = jQuery._data(this), queue = data[type + 'queue'], hooks = data[type + 'queueHooks'], timers = jQuery.timers, length = queue ? queue.length : 0; for (data.finish = !0, jQuery.queue(this, type, []), hooks && hooks.stop && hooks.stop.call(this, !0), index = timers.length; index--;)
                    ...
                    jQuery.fn.extend({ val: function (value) { var hooks, ret, isFunction, elem = this[0]; return arguments.length ? (isFunction = jQuery.isFunction(value), this.each(function (i) { var val; 1 !== this.nodeType || (val = isFunction ? value.call(this, i, jQuery(this).val()) : value, null == val ? val = '' : 'number' == typeof val ? val += '' : jQuery.isArray(val) && (val = jQuery.map(val, function (value) { return null == value ? '' : value + ''; })), hooks = jQuery.valHooks[this.type] || jQuery.valHooks[this.nodeName.toLowerCase()], (!hooks || !('set' in hooks) || void 0 === hooks.set(this, val, 'value')) && (this.value = val)); })) : elem ? (hooks = jQuery.valHooks[elem.type] || jQuery.valHooks[elem.nodeName.toLowerCase()], hooks && 'get' in hooks && void 0 !== (ret = hooks.get(elem, 'value'))) ? ret : (ret = elem.value, 'string' == typeof ret ? ret.replace(rreturn, '') : null == ret ? '' : ret) : void 0; } }), jQuery.extend({ valHooks: { option: { get: function (elem) { var val = jQuery.find.attr(elem, 'value'); return null == val ? jQuery.trim(jQuery.text(elem)).replace(rspaces, ' ') : val; } }, select: { get: function (elem) { for (var value, option, options = elem.options, index = elem.selectedIndex, one = 'select-one' === elem.type || 0 > index, values = one ? null : [], max = one ? index + 1 : options.length, i = 0 > index ? max : one ? index : 0; i < max; i++)
                                    if (option = options[i], (option.selected || i === index) && (support.optDisabled ? !option.disabled : null === option.getAttribute('disabled')) && (!option.parentNode.disabled || !jQuery.nodeName(option.parentNode, 'optgroup'))) {
                                        if (value = jQuery(option).val(), one)
                                            return value;
                                        values.push(value);
                                    } return values; }, set: function (elem, value) { for (var optionSet, option, options = elem.options, values = jQuery.makeArray(value), i = options.length; i--;)
                    ...
                    jQuery.fn.extend({ attr: function (name, value) { return access(this, jQuery.attr, name, value, 1 < arguments.length); }, removeAttr: function (name) { return this.each(function () { jQuery.removeAttr(this, name); }); } }), jQuery.extend({ attr: function (elem, name, value) { var ret, hooks, nType = elem.nodeType; if (3 !== nType && 8 !== nType && 2 !== nType)
                            return 'undefined' == typeof elem.getAttribute ? jQuery.prop(elem, name, value) : (1 === nType && jQuery.isXMLDoc(elem) || (name = name.toLowerCase(), hooks = jQuery.attrHooks[name] || (jQuery.expr.match.bool.test(name) ? boolHook : nodeHook)), void 0 !== value) ? null === value ? void jQuery.removeAttr(elem, name) : hooks && 'set' in hooks && void 0 !== (ret = hooks.set(elem, value, name)) ? ret : (elem.setAttribute(name, value + ''), value) : hooks && 'get' in hooks && null !== (ret = hooks.get(elem, name)) ? ret : (ret = jQuery.find.attr(elem, name), null == ret ? void 0 : ret); }, attrHooks: { type: { set: function (elem, value) { if (!support.radioValue && 'radio' === value && jQuery.nodeName(elem, 'input')) {
                                ...
                                } } } }, removeAttr: function (elem, value) { var name, propName, i = 0, attrNames = value && value.match(rnotwhite); if (attrNames && 1 === elem.nodeType)
                    ...
                    jQuery.fn.extend({ prop: function (name, value) { return access(this, jQuery.prop, name, value, 1 < arguments.length); }, removeProp: function (name) { return name = jQuery.propFix[name] || name, this.each(function () { try {
                        ...
                        catch (e) { } }); } }), jQuery.extend({ prop: function (elem, name, value) { var ret, hooks, nType = elem.nodeType; if (3 !== nType && 8 !== nType && 2 !== nType)
                    ...
                    var rclass = /[\t\r\n\f]/g;
                    jQuery.fn.extend({ addClass: function (value) { var classes, elem, cur, curValue, clazz, j, finalValue, i = 0; if (jQuery.isFunction(value))
                            ...
                            for (classes = value.match(rnotwhite) || []; elem = this[i++];)
                                ...
                                } return this; }, removeClass: function (value) { var classes, elem, cur, curValue, clazz, j, finalValue, i = 0; if (jQuery.isFunction(value))
                            ...
                            for (classes = value.match(rnotwhite) || []; elem = this[i++];)
                                if (curValue = getClass(elem), cur = 1 === elem.nodeType && (' ' + curValue + ' ').replace(rclass, ' '), cur) {
                                    ...
                                    finalValue = jQuery.trim(cur), curValue !== finalValue && jQuery.attr(elem, 'class', finalValue);
                                } return this; }, toggleClass: function (value, stateVal) { var type = _typeof(value); return 'boolean' == typeof stateVal && 'string' == type ? stateVal ? this.addClass(value) : this.removeClass(value) : jQuery.isFunction(value) ? this.each(function (i) { jQuery(this).toggleClass(value.call(this, i, getClass(this), stateVal), stateVal); }) : this.each(function () { var className, i, self, classNames; if ('string' == type)
                            ...
                            (void 0 === value || 'boolean' == type) && (className = getClass(this), className && jQuery._data(this, '__className__', className), jQuery.attr(this, 'class', className || !1 === value ? '' : jQuery._data(this, '__className__') || '')); }); }, hasClass: function (selector) { var className, elem, i = 0; for (className = ' ' + selector + ' '; elem = this[i++];)
                    ...
                    jQuery.parseJSON = function (data) { if (window.JSON && window.JSON.parse)
                        return window.JSON.parse(data + ''); var requireNonComma, depth = null, str = jQuery.trim(data + ''); return str && !jQuery.trim(str.replace(rvalidtokens, function (token, comma, open, close) { return (requireNonComma && comma && (depth = 0), 0 === depth) ? token : (requireNonComma = open || comma, depth += !close - !open, ''); })) ? Function('return ' + str)() : jQuery.error('Invalid JSON: ' + data); }, jQuery.parseXML = function (data) { var xml, tmp; if (!data || 'string' != typeof data)
                        return null; try {
                    ...
                    jQuery.param = function (a, traditional) { var prefix, s = [], add = function (key, value) { value = jQuery.isFunction(value) ? value() : null == value ? '' : value, s[s.length] = encodeURIComponent(key) + '=' + encodeURIComponent(value); }; if (void 0 === traditional && (traditional = jQuery.ajaxSettings && jQuery.ajaxSettings.traditional), jQuery.isArray(a) || a.jquery && !jQuery.isPlainObject(a))
                    ...
                    window.attachEvent && window.attachEvent('onunload', function () { for (var key in xhrCallbacks)
                        ...
                        var _callback;
                        return { send: function (headers, complete) { var i, xhr = options.xhr(), id = ++xhrId; if (xhr.open(options.type, options.url, options.async, options.username, options.password), options.xhrFields)
                                ...
                                void 0 !== headers[i] && xhr.setRequestHeader(i, headers[i] + ''); xhr.send(options.hasContent && options.data || null), _callback = function (_, isAbort) { var status, statusText, responses; if (_callback && (isAbort || 4 === xhr.readyState))
                                if (delete xhrCallbacks[id], _callback = void 0, xhr.onreadystatechange = jQuery.noop, isAbort)
                                ...
                                } responses && complete(status, statusText, responses, xhr.getAllResponseHeaders()); }, options.async ? 4 === xhr.readyState ? window.setTimeout(_callback) : xhr.onreadystatechange = xhrCallbacks[id] = _callback : _callback(); }, abort: function () { _callback && _callback(void 0, !0); } };
        ...
        \****************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { var __awaiter = this && this.__awaiter || function (thisArg, _arguments, P, generator) { function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); } return new (P || (P = Promise))(function (resolve, reject) { function fulfilled(value) { try {
            ...
            } }); }); }; inputDom.onkeydown = function () { onInputTextChange(this.value); }, inputDom.onfocus = function () { document.getElementById(dropdown.id).style.display = 'block'; }; var dropdown = _1.Dropdown({}); return dropdown = utils_1.getElementWithClassNames(dropdown, ['auto-complete__dropdown']), dropdown = utils_1.getElementWithStyle(dropdown, [{ key: 'display', value: 'none' }]), dropdown.id = utils_1.elementIdGenerator.gererate(), options.forEach(function (option) { var listItem = document.createElement('div'); listItem.onclick = function () { setInputValue(option.label); }, listItem.innerHTML = option.label, dropdown.appendChild(listItem); }), $(document).click(function (e) { var getDropdown = document.getElementById(dropdown.id); 'none' === getDropdown.style.display || getDropdown.contains(e.target) || getInput().contains(e.target) || (getDropdown.style.display = 'none'); }), autoCompleteWrap.appendChild(inputDom), autoCompleteWrap.appendChild(dropdown), autoCompleteWrap; }, 'AutoComplete'); }, "./src/Components/dialog.ts": /*!**********************************!*\
            !*** ./src/Components/dialog.ts ***!
            \**********************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var utils_1 = __webpack_require__(/*! ../utils */ './src/utils.ts'); exports['default'] = utils_1.withErrorHandling(function (_a) { var htmlSrc = _a.htmlSrc, _b = _a.dialogArguments, dialogArguments = void 0 === _b ? {} : _b, _c = _a.height, height = void 0 === _c ? 250 : _c, _d = _a.width, width = void 0 === _d ? 850 : _d; window.showModalDialog(htmlSrc, dialogArguments, 'dialogHeight:' + height + 'px;dialogWidth:' + width + 'px'); }, 'Dialog'); }, "./src/Components/dropdown.ts": /*!************************************!*\
            !*** ./src/Components/dropdown.ts ***!
            \************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var utils_1 = __webpack_require__(/*! ../utils */ './src/utils.ts'); exports['default'] = utils_1.withErrorHandling(function (_a) { var children = _a.children, dropdown = utils_1.createElement({ tagName: 'div' }); return dropdown = utils_1.getElementWithClassNames(dropdown, ['didgah-dropdown']), children && dropdown.appendChild(children), dropdown; }, 'DropDown'); }, "./src/Components/dynamicData/dynamicDataModal.ts": /*!********************************************************!*\
            !*** ./src/Components/dynamicData/dynamicDataModal.ts ***!
            \********************************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { var __assign = this && this.__assign || function () { return __assign = Object.assign || function (t) { for (var s, i = 1, n = arguments.length; i < n; i++)
                for (var p in s = arguments[i], s)
                    Object.prototype.hasOwnProperty.call(s, p) && (t[p] = s[p]); return t; }, __assign.apply(this, arguments); }; exports.__esModule = !0; var simple_modal_1 = __webpack_require__(/*! ../simple-modal */ './src/Components/simple-modal.ts'), utils_1 = __webpack_require__(/*! ../../utils */ './src/utils.ts'); exports['default'] = function (_a) { var fields = _a.fields, formData = _a.formData, editCellRenderer = _a.editCellRenderer, onSubmit = _a.onSubmit, _b = simple_modal_1['default'](), modal = _b.modal, onClose = _b.onClose, formId = utils_1.elementIdGenerator.gererate(), form = utils_1.createElement({ tagName: 'form', props: { id: formId } }), bundleFields = fields.filter(function (field) { return !0 === field.Type.IsBundle; }).map(function (field) { return field.name; }); fields.map(function (field) { var wrap = utils_1.createElement({ tagName: 'div' }); field.formData = formData[field.name], field.Type.IsBundle ? wrap.appendChild(editCellRenderer(__assign(__assign({}, field), { onUpdateFormData: function (d) { formData[field.name] = d; } })).input) : wrap.appendChild(editCellRenderer(field).input), form.appendChild(wrap); }), modal.appendChild(form); var buttonWrap = utils_1.createElement({ tagName: 'div', props: { className: 'center' } }), button = utils_1.createElement({ tagName: 'input', props: { type: 'submit', className: 'submit-button', onclick: function () { console.log(formData), console.log(bundleFields.map(function (field) { return formData[field.name]; })), console.log(__assign(__assign({}, bundleFields.map(function (field) { return formData[field.name]; })), utils_1.formToJSON('#' + formId))); } } }); return buttonWrap.appendChild(button), modal.appendChild(buttonWrap), modal; }; }, "./src/Components/dynamicData/gride.ts": /*!*********************************************!*\
            ...
            \*********************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { var __assign = this && this.__assign || function () { return __assign = Object.assign || function (t) { for (var s, i = 1, n = arguments.length; i < n; i++)
                ...
                for (var a = arguments[i], j = 0, jl = a.length; j < jl; j++, k++)
                    r[k] = a[j]; return r; }; exports.__esModule = !0; var utils_1 = __webpack_require__(/*! ../../utils */ './src/utils.ts'), staticComponents_1 = __webpack_require__(/*! ./staticComponents */ './src/Components/dynamicData/staticComponents.ts'), tableBaseOnRow_1 = __webpack_require__(/*! ../tableBaseOnRow */ './src/Components/tableBaseOnRow.ts'), dynamicDataModal_1 = __webpack_require__(/*! ./dynamicDataModal */ './src/Components/dynamicData/dynamicDataModal.ts'); exports.toTD = function (data, currentDocument) { void 0 === currentDocument && (currentDocument = window.document); var td = utils_1.createElement({ tagName: 'td', props: __assign({}, data.cellProps) }); return td.appendChild(data.input), td; }, exports['default'] = utils_1.withErrorHandling(function (_a) { function getRowElements(index) { return __spreadArrays([exports.toTD(staticComponents_1.removeCell(index, onRemove))], tableBaseOnRow_1.mapIntoTD(rowsData.fields.map(function (fieldData) { return __assign({}, displayCellRenderer(__assign(__assign({}, fieldData), { formData: formData[index][fieldData.name] }))); })), [exports.toTD(staticComponents_1.settingCell(index, onSetting))]); } function onAdd() { var modal = dynamicDataModal_1['default']({ fields: rowsData.fields, formData: formData, editCellRenderer: editCellRenderer, onSubmit: function (data) { formData.push(data), onUpdateFormData && onUpdateFormData(formData); var tr = utils_1.createElement({ tagName: 'tr', props: {} }), removeTd = exports.toTD(staticComponents_1.removeCell(formData.length - 1, onRemove)); tr.appendChild(removeTd); var _loop_1 = function (item) { var mainTd = exports.toTD(displayCellRenderer(__assign(__assign({}, rowsData.fields.find(function (field) { return field.name === item; })), { formData: data[item] }))); console.log(mainTd), tr.appendChild(mainTd); }; for (var item in data)
                    _loop_1(item); var settingTd = exports.toTD(staticComponents_1.settingCell(formData.length - 1, onSetting)); tr.appendChild(settingTd), document.getElementById(tableBodyId).insertBefore(tr, document.getElementById(tableBodyId).lastChild); } }); document.getElementById('root').appendChild(modal); } function onRemove(index) { formData.splice(index, 1), onUpdateFormData && onUpdateFormData(formData); var tableBody = document.getElementById(tableBodyId); tableBody.removeChild(tableBody.childNodes[index]); } function onSetting(index) { var modal = dynamicDataModal_1['default']({ fields: rowsData.fields, formData: formData[index], editCellRenderer: editCellRenderer, onSubmit: function (d) { changeRowData(index, d); } }); modal && document.getElementById('root').appendChild(modal); } function changeRowData(index, data) { formData[index] = data, onUpdateFormData && onUpdateFormData(formData); for (var td, tableBody = document.getElementById(tableBodyId), tr = utils_1.createElement({ tagName: 'tr' }), _i = 0, _a = getRowElements(index); _i < _a.length; _i++)
                ...
                for (var td, row = displayRows_1[_a], tr = utils_1.createElement({ tagName: 'tr', props: {} }), _b = 0, _c = row.renderer; _b < _c.length; _b++)
                    td = _c[_b], tr.appendChild(td);
                tableBody.appendChild(tr);
            } return tableHead.appendChild(tableheadrow), tableDom.appendChild(tableHead), tableDom.appendChild(tableBody), tableDom; }(); }, 'DynamicData/Grid'); }, "./src/Components/dynamicData/staticComponents.ts": /*!********************************************************!*\
            !*** ./src/Components/dynamicData/staticComponents.ts ***!
            \********************************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var tableBaseOnRow_1 = __webpack_require__(/*! ../tableBaseOnRow */ './src/Components/tableBaseOnRow.ts'), utils_1 = __webpack_require__(/*! ../../utils */ './src/utils.ts'); exports.addNewRow = function (onAdd) { return { renderer: tableBaseOnRow_1.mapIntoTD([{ input: utils_1.createElement({ tagName: 'input', props: { className: 'dynamic-table__row__add-button', type: 'button', value: '+', onclick: function () { onAdd(); } } }) }]) }; }, exports.removeCell = function (index, onRemove) { return { input: utils_1.createElement({ tagName: 'input', props: { className: 'dynamic-table__row__remove-button', type: 'button', value: 'x', onclick: function () { onRemove(index); } } }), cellProps: { style: { width: '50px' } } }; }, exports.settingCell = function (index, onSetting) { return { input: utils_1.createElement({ tagName: 'input', props: { className: 'dynamic-table__row__setting-button', type: 'button', value: '...', onclick: function () { onSetting(index); } } }) }; }; }, "./src/Components/index.ts": /*!*********************************!*\
            !*** ./src/Components/index.ts ***!
            \*********************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var table_1 = __webpack_require__(/*! ./table */ './src/Components/table.ts'); exports.Table = table_1['default']; var tableBaseOnRow_1 = __webpack_require__(/*! ./tableBaseOnRow */ './src/Components/tableBaseOnRow.ts'); exports.TableBaseOnRow = tableBaseOnRow_1['default']; var dialog_1 = __webpack_require__(/*! ./dialog */ './src/Components/dialog.ts'); exports.Dialog = dialog_1['default']; var select_1 = __webpack_require__(/*! ./select */ './src/Components/select.ts'); exports.Select = select_1['default']; var dropdown_1 = __webpack_require__(/*! ./dropdown */ './src/Components/dropdown.ts'); exports.Dropdown = dropdown_1['default']; var autoComplete_1 = __webpack_require__(/*! ./autoComplete */ './src/Components/autoComplete.ts'); exports.autoCompelete = autoComplete_1['default']; var withLabel_1 = __webpack_require__(/*! ./withLabel */ './src/Components/withLabel.ts'); exports.withLabel = withLabel_1['default']; }, "./src/Components/select.ts": /*!**********************************!*\
            !*** ./src/Components/select.ts ***!
            \**********************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var utils_1 = __webpack_require__(/*! ../utils */ './src/utils.ts'); exports['default'] = utils_1.withErrorHandling(function (_a) { var options = _a.options, value = _a.value, name = _a.name, select = utils_1.createElement({ tagName: 'select', props: { value: value, name: name } }); return options.map(function (option) { var domOption = utils_1.createElement({ tagName: 'option' }); domOption.setAttribute('value', option.value), domOption.innerHTML = option.label, select.appendChild(domOption); }), select; }, 'Select'); }, "./src/Components/simple-modal.ts": /*!****************************************!*\
            !*** ./src/Components/simple-modal.ts ***!
            \****************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { function removeElement(id) { var node = document.getElementById(id); node.parentNode && node.parentNode.removeChild(node); } exports.__esModule = !0; var $ = __webpack_require__(/*! jquery */ './node_modules/jquery/dist/jquery.js'), utils_1 = __webpack_require__(/*! ../utils */ './src/utils.ts'); exports.removeElement = removeElement, exports['default'] = function () { function onClose() { removeElement(modalId), removeElement(overlayId); } var modalId = utils_1.elementIdGenerator.gererate(), overlayId = utils_1.elementIdGenerator.gererate(), lastModal = $('.simple-modal'), overlay = utils_1.createElement({ tagName: 'div', props: { id: overlayId, className: 'simple-modal__overlay' } }); 0 === lastModal.length ? document.getElementById('root').appendChild(overlay) : lastModal.after(overlay); var leftPosition = (.5 * window.screen.width - 300).toString() + 'px', wrap = utils_1.createElement({ tagName: 'div', props: { id: modalId, className: 'simple-modal', style: { left: leftPosition } } }), inner = utils_1.createElement({ tagName: 'div', props: { className: 'simple-modal__inner' } }), close = utils_1.createElement({ tagName: 'input', props: { type: 'button', value: 'x', className: 'simple-modal__close', onclick: onClose } }); inner.appendChild(close); var content = utils_1.createElement({ tagName: 'div', props: { className: 'simple-modal__content' } }); return inner.appendChild(content), wrap.appendChild(inner), { modal: wrap, onClose: onClose }; }; }, "./src/Components/table.ts": /*!*********************************!*\
            !*** ./src/Components/table.ts ***!
            \*********************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var utils_1 = __webpack_require__(/*! ../utils */ './src/utils.ts'); exports['default'] = utils_1.withErrorHandling(function (_a) { for (var dataSource = _a.dataSource, columns = _a.columns, dataToDisplay = columns.map(function (column) { return column.dataIndex; }), tableDom = utils_1.createElement({ tagName: 'table' }), tableHead = utils_1.createElement({ tagName: 'thead' }), tableheadrow = utils_1.createElement({ tagName: 'tr' }), tableBody = utils_1.createElement({ tagName: 'tbody' }), _i = 0, columns_1 = columns; _i < columns_1.length; _i++) {
                ...
                for (var d, data_1 = dataSource_1[_b], tr = utils_1.createElement({ tagName: 'tr' }), tds = [], _loop_1 = function (d) { var td = utils_1.createElement({ tagName: 'td' }), renderer = columns.find(function (column) { return column.dataIndex === d; }).renderer; if (renderer) {
                    ...
                    td.innerHTML = data_1[d]; tds.push(td); }, _c = 0, dataToDisplay_1 = dataToDisplay; _c < dataToDisplay_1.length; _c++)
                    d = dataToDisplay_1[_c], _loop_1(d);
                for (var td, _d = 0, tds_1 = tds; _d < tds_1.length; _d++)
                    td = tds_1[_d], tr.appendChild(td);
                tableBody.appendChild(tr);
            } return tableHead.appendChild(tableheadrow), tableDom.appendChild(tableHead), tableDom.appendChild(tableBody), tableDom; }, 'Table'); }, "./src/Components/tableBaseOnRow.ts": /*!******************************************!*\
            !*** ./src/Components/tableBaseOnRow.ts ***!
            \******************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var utils_1 = __webpack_require__(/*! ../utils */ './src/utils.ts'), gride_1 = __webpack_require__(/*! ./dynamicData/gride */ './src/Components/dynamicData/gride.ts'); exports.mapIntoTD = function (data) { return void 0 === data && (data = []), data.map(function (item) { return gride_1.toTD(item); }); }, exports['default'] = utils_1.withErrorHandling(function (_a) { for (var rows = _a.rows, tableDom = utils_1.createElement({ tagName: 'table', props: { className: 'table-base-row' } }), tableBody = utils_1.createElement({ tagName: 'tbody' }), _i = 0, rows_1 = rows; _i < rows_1.length; _i++) {
                for (var td, row = rows_1[_i], tr = utils_1.createElement({ tagName: 'tr', props: {} }), _b = 0, _c = row.renderer; _b < _c.length; _b++)
                    td = _c[_b], tr.appendChild(td);
                tableBody.appendChild(tr);
            } return tableDom.appendChild(tableBody), tableDom; }, 'TableBasedRow'); }, "./src/Components/withLabel.ts": /*!*************************************!*\
            !*** ./src/Components/withLabel.ts ***!
            \*************************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var utils_1 = __webpack_require__(/*! ../utils */ './src/utils.ts'); exports['default'] = utils_1.withErrorHandling(function (input, title, currentDocument) { void 0 === currentDocument && (currentDocument = window.document); var wrapper = utils_1.createElement({ tagName: 'div', props: { className: 'with-label' } }), label = utils_1.createElement({ tagName: 'label', props: { className: 'with-label__label' } }); return label.innerHTML = title, wrapper.appendChild(label), wrapper.appendChild(input), wrapper; }, 'withLabel'); }, "./src/index.ts": /*!**********************!*\
            !*** ./src/index.ts ***!
            \**********************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var gride_1 = __webpack_require__(/*! ./Components/dynamicData/gride */ './src/Components/dynamicData/gride.ts'); exports.DynamicDataGrid = gride_1['default']; var utils_1 = __webpack_require__(/*! ./utils */ './src/utils.ts'); exports.createElement = utils_1.createElement, exports.renderIntoRoot = utils_1.renderIntoRoot, exports.formToJSON = utils_1.formToJSON, exports.elementIdGenerator = utils_1.elementIdGenerator, exports.dialogFormToJSON = utils_1.dialogFormToJSON, exports.currentDocumentObj = utils_1.currentDocumentObj; var Components_1 = __webpack_require__(/*! ./Components */ './src/Components/index.ts'); exports.withLabel = Components_1.withLabel; var tableBaseOnRow_1 = __webpack_require__(/*! ./Components/tableBaseOnRow */ './src/Components/tableBaseOnRow.ts'); exports.mapIntoTD = tableBaseOnRow_1.mapIntoTD; }, "./src/utils.ts": /*!**********************!*\
            !*** ./src/utils.ts ***!
            \**********************/ /*! no static exports found */ function (module, exports, __webpack_require__) { exports.__esModule = !0; var $ = __webpack_require__(/*! jquery */ './node_modules/jquery/dist/jquery.js'); exports.currentDocumentObj = { currentDocument: null, getCurrentDocument: function () { return this.currentDocument; }, setCurentDocument: function (doc) { this.currentDocument = doc; } }, exports.container = document.getElementById('root'), exports.isObjectDomElement = function (object) { return object.scopeName && 'HTML' === object.scopeName; }, exports.getElementWithStyle = function (element, styles) { var clonedObject = element.cloneNode(); return styles.forEach(function (style) { clonedObject.style[style.key] = style.value; }), clonedObject; }, exports.renderIntoRoot = function (element) { exports.container.appendChild(element); }, exports.getElementWithClassNames = function (element, classNames) { var clonedObject = element.cloneNode(!0); return classNames.forEach(function (className) { clonedObject.className += ' ' + className; }), clonedObject; }, exports.elementIdGenerator = { busyIds: [], gererate: function () { var id = Math.random().toString(36).substr(2, 9); return 0 !== document.querySelectorAll('#' + id).length || this.busyIds.find(function (item) { return item === id; }) ? void this.gererate() : (this.busyIds.push(id), id.toString()); } }, exports.createElement = function (_a) { var tagName = _a.tagName, props = _a.props, onMount = _a.onMount, element = window.document.createElement(tagName), idGenerator = exports.elementIdGenerator; for (var prop in props)
                if ('style' === prop)
                    for (var style in props[prop])
                        element.style[style] = props[prop][style];
                else
                    element[prop] = props[prop]; return onMount && ((!props || !props.id) && (element.id = idGenerator.gererate()), $(element.id).ready(function () { onMount(); })), element; }, exports.withErrorHandling = function (component, componentName) { return function () { for (var args = [], _i = 0; _i < arguments.length; _i++)
                args[_i] = arguments[_i]; try {
                return component.apply(void 0, args);
            }
            catch (e) {
                alert('error happend in ' + componentName + ' ' + e.message || !1);
            } }; }, exports.formToJSON = function (selector) { var form = {}; return document.querySelectorAll(selector + ' input').forEach(function (el) { var name = el.getAttribute('fieldName'); form[name] = el.getAttribute('value'); }), form; }, exports.dialogFormToJSON = function () { var form = {}; return $('input[type="text"]').each(function () { var self = $(this), name = self.attr('fieldName'); form[name] = form[name] ? form[name] + ',' + self.val() : self.val(); }), form; }, exports.importModule = function (url) { var refinedUrl = url; return new Promise(function (resolve, reject) { var script = document.createElement('script'); script.src = refinedUrl, script.async = !0, script.onload = function () { resolve(), script.remove(); }, script.onerror = function () { reject(new Error('Failed to load module script with URL ' + refinedUrl)), script.remove(); }, document.head.appendChild(script); }); }; }, 0: /*!****************************!*\
            !*** multi ./src/index.ts ***!
            \****************************/ /*! no static exports found */ function (module, exports, __webpack_require__) { module.exports = __webpack_require__(/*! ./src/index.ts */ './src/index.ts'); } });
    }, "./src/anotherGrid.ts": /*!****************************!*\
    !*** ./src/anotherGrid.ts ***!
    \****************************/ /*! no static exports found */ function (module, exports, __webpack_require__) {
        'use strict';
        exports.__esModule = !0;
        var libraryName = __webpack_require__(/*! gulp-es3-typescript-library */ '../library/dist/index.js'), lib = libraryName.lib;
        exports['default'] = { headers: ['field 0'], displayCellRenderer: function (d) { return { input: lib.createElement({ tagName: 'input', props: { fieldName: d.name, onclick: function () { } } }), cellProps: { colSpan: d.col } }; }, editCellRenderer: function (d) { return { input: lib.createElement({ tagName: 'input', props: { value: d.formData || '', fieldName: d.name } }), cellProps: { colSpan: d.col } }; }, rowsData: { fields: [{ name: 'field 0', col: 1, Type: { IsBundle: !1 } }] } };
    }, "./src/main.ts": /*!*********************!*\
    !*** ./src/main.ts ***!
    \*********************/ /*! no static exports found */ function (module, exports, __webpack_require__) {
        'use strict';
        var __assign = this && this.__assign || function () { return __assign = Object.assign || function (t) { for (var s, i = 1, n = arguments.length; i < n; i++)
            for (var p in s = arguments[i], s)
                Object.prototype.hasOwnProperty.call(s, p) && (t[p] = s[p]); return t; }, __assign.apply(this, arguments); };
        exports.__esModule = !0;
        var libraryName = __webpack_require__(/*! gulp-es3-typescript-library */ '../library/dist/index.js'), anotherGrid_1 = __webpack_require__(/*! ./anotherGrid */ './src/anotherGrid.ts'), lib = libraryName.lib, grid = lib.DynamicDataGrid({ headers: ['countryname', 'date', 'gridField'], initialFormData: [{ countryname: 'netherlands', countrycode: '', gridField: [{ a: 'Armin' }] }], displayCellRenderer: function (d) { return console.log(d.name, d.col), { input: lib.createElement({ tagName: 'span', props: { id: 'date' === d.name ? 'from-date-datePicker' : '', style: { width: '240px' } }, onMount: function () { window.document.getElementById('from-date-datePicker').innerHTML = '<input type=\'text\' style=\'display:none;\' id=\'txt123456\' name="' + (d.name || '') + '" value="' + (d.value || '') + '" /><ccc:datePicker showTime=\'true\' forceShowTime=\'true\'/>'; } }), cellProps: { colSpan: d.col } }; }, editCellRenderer: function (d) { return d.Type.IsBundle ? { input: lib.DynamicDataGrid(__assign(__assign({}, anotherGrid_1['default']), { onUpdateFormData: d.onUpdateFormData })), cellProps: { colSpan: d.col } } : { input: lib.withLabel(lib.createElement({ tagName: 'input' }), d.name), cellProps: { colSpan: d.col } }; }, rowsData: { fields: [{ name: 'countryname', col: 1, Type: { IsBundle: !1 } }, { name: 'date', col: 3, Type: { IsBundle: !1 } }, { name: 'gridField', col: 1, Type: { IsBundle: !0 } }] } });
